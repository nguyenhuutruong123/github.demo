...
public class TraDonHang implements ITraDonHang
{
	...
	public TraDonHang(String[] param)
	{
		this.id = param[0];
		this.khId = param[1];
	...
	{		
		...
		this.tongtientruocVAT= tonggiatri+"";
