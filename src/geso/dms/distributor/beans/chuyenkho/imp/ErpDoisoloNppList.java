...
public class ErpDoisoloNppList implements IErpDoisoloNppList
{
	...
	public void init(String search) 
	{
		...
		if (search.length() == 0)
		{
			query = "select a.pk_seq, a.trangthai, a.ngaydoi, b.diengiai as kbhTen, e.ten as khoTEN, a.ngaytao, c.ten as nguoitao, a.ngaysua, d.ten as nguoisua  " +
