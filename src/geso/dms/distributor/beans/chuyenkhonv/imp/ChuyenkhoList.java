...
public class ChuyenkhoList implements IChuyenkhoList
{
	...
	public void init(String search) 
	{
		...
		this.chuyenkhoNVRs = db.get(query);
	...
	{
		return this.chuyenkhoNVRs;
	}

	public void setRsChuyenKho(ResultSet rschuyenkhoNV) 
	{
		this.chuyenkhoNVRs = rschuyenkhoNV;
	}
