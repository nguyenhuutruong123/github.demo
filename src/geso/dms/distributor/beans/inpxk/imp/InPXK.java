...
public class InPXK implements IInPXK, Serializable
{
	...
	public void init2()
	{
        ...
        String query = " select b.pk_seq as dhId, dd.ten as NVBH, b.ngaynhap, isnull(a.tonggiatri, '0') as tonggiatri,c.smartid, c.pk_seq as khId, c.ten as khTen, c.diachi as dc ";
        query += "from phieuxuatkho_donhang a inner join donhang b on a.donhang_fk = b.pk_seq " +
        		" inner join daidienkinhdoanh dd on dd.pk_seq = b.ddkd_fk " +
        		"inner join khachhang c on b.khachhang_fk = c.pk_seq where a.pxk_fk = '" + this.id + "' "; 
	...
	{
		System.out.println("");
		String sql = "select donhang_fk from phieuxuatkho_donhang where pxk_fk in ('" + this.id + "')";
