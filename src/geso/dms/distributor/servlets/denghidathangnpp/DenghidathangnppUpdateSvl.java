...
public class DenghidathangnppUpdateSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if(!util.check(userId, userTen, sum)){
				...
				String nextJSP;
					nextJSP = "/AHF/pages/Distributor/DeNghiDatHangNppDislay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if(!util.check(userId, userTen, sum)){
				...
				String tongchuavat = util.antiSQLInspection(geso.dms.center.util.Utility.antiSQLInspection(request.getParameter("tongchuavat")));
			    ...
			    dndhBean.setVat(vat);
			    String tongcovat = util.antiSQLInspection(geso.dms.center.util.Utility.antiSQLInspection(request.getParameter("tongcovat")));
