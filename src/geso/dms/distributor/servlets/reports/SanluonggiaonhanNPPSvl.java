...
@WebServlet("/SanluonggiaonhanNPPSvl")
public class SanluonggiaonhanNPPSvl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public SanluonggiaonhanNPPSvl() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = "/AHF/pages/Distributor/SanLuongNVGNDist.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		obj.setnppTen(util.getTenNhaPP());
		
		String sql = " where npp.pk_seq = '"+obj.getnppId()+"' ";
	...
	{	
	    ...
	    ReportAPI.getCellStyle(cell, Color.NAVY, true, 9, "Được tạo bởi:  " + obj.getnppTen());
