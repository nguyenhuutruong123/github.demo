	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
    		...
    		if(!querystring.contains("display"))
    			nextJSP = "/AHF/pages/Distributor/ErpChuyenKhoNppUpdate.jsp";
    		else
    			nextJSP = "/AHF/pages/Distributor/ErpChuyenKhoNppDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			{	
				if(id == null)
				{
					if(!lsxBean.createNK())
					{
						lsxBean.createRs();
	    		    	session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = "/AHF/pages/Distributor/ErpChuyenKhoNppNew.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
			    		...
			    		response.sendRedirect("/AHF/pages/Distributor/ErpChuyenKhoNpp.jsp");
					}
				}
				else
				{
					if(!lsxBean.updateNK())
					{
						lsxBean.createRs();
						session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = "/AHF/pages/Distributor/ErpChuyenKhoNppUpdate.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
					    ...
					    obj.init("");
						session.setAttribute("obj", obj);							
						String nextJSP = "/AHF/pages/Distributor/ErpChuyenKhoNpp.jsp";
						response.sendRedirect(nextJSP);
					}
				}
			}
			else
			{
				...
				nextJSP = "/AHF/pages/Distributor/ErpChuyenKhoNppNew.jsp";
				if(id != null)
					nextJSP = "/AHF/pages/Distributor/ErpChuyenKhoNppUpdate.jsp";
