	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(!cutil.check(userId, userTen, sum)){
	    	...
	    	if(action.equals("update"))
	    		response.sendRedirect("/AHF/pages/Distributor/DangKyKhuyenMaiTichLuyNew.jsp");
	    	
	    	else if(action.equals("dislay")){
	    		response.sendRedirect("/AHF/pages/Distributor/DangKyKhuyenMaiTichLuyDisplay.jsp");
					...
					{						
						...
						{	
							...
							if (cells.length >= 3){
								...
								String muc_dk = cells[4].getContents().toString();
								...
								kh_muc.put(KHACHHANG_FK.trim(), Integer.parseInt(muc_dk));
						...
						obj.getId_Khachhang(khachhang_fks, kh_muc, kh_st);
