...
public class CtkhuyenmaiDuyetSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;

	PrintWriter out;

	public CtkhuyenmaiDuyetSvl() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String nextJSP = "/AHF/pages/Center/ChuongTrinhKhuyenMaiDuyet.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			if (action.equals("Tao moi"))
			{
				...
				session.setAttribute("obj", obj);
				response.sendRedirect("/AHF/pages/Center/ChuongTrinhKhuyenMaiDuyet.jsp");
	...
	{	
		...
		query = query +" order by a.TUNGAY desc,a.isduyet  asc";
	...
	private String Duyet(String ctkmId) 
	{
		dbutils db = new dbutils();
		try 
		{
			db.getConnection().setAutoCommit(false);
			String sql = "update ctkhuyenmai set isduyet = '1', ismail = '0' where pk_seq = '" + ctkmId + "' and isduyet = '2' ";
	...
	private String BoDuyet(String ctkmId) 
	{
		...
		{
			db.getConnection().setAutoCommit(false);
			String sql = "update ctkhuyenmai set isduyet = '0', ismail = '0' where pk_seq = '" + ctkmId + "' and isduyet = '1' and ismail = '1' ";
			if(db.updateReturnInt(sql) != 1)
			{
				db.getConnection().rollback();
				return "Không thể duyệt.";
