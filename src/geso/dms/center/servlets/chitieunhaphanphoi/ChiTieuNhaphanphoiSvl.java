...
public class ChiTieuNhaphanphoiSvl extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ChiTieuNhaphanphoiSvl() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		IChiTieuNhaphanphoi obj = new ChiTieuNhaphanphoi();
		...
		if( Utility.CheckRuleUser( session,  request, response, "ChiTieuNhaphanphoiSvl", param, Utility.XEM )) {
			Utility.RedireactLogin(session, request, response);
		}
		...
		String nextJSP = "/AHF/pages/Center/ChiTieuNhaphanphoi.jsp";//default

		String loaict="1";
		if(action.equals("delete")){
			if(view.trim().length() > 0) param = "&view=" + view;
			int[] quyen = Utility.Getquyen("ChiTieuNhaphanphoiSvl", param, userId);
			...
			nextJSP= "/AHF/pages/Center/ChiTieuNhaphanphoiUpdate.jsp";
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(action.equals("new"))
		{
			...
			String	nextJSP= "/AHF/pages/Center/ChiTieuNhaphanphoiUpdate.jsp";
			response.sendRedirect(nextJSP);
