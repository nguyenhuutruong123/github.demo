...
public class ErpDondathangExcelSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;

	PrintWriter out;
	public ErpDondathangExcelSvl() 
	{
		super();
	}
	...
	private String XuatFileExcel(HttpServletResponse response, String id) throws IOException
	{
		...
		try 
		{
			...
			try
			{
				...
				String query = "select b.MA as MaSanPham, b.TEN as TenSanPham, a.SOLUONG, a.SOLUONGTTDUYET, a.GHICHU ,a.NgayGiaoHang    " +
						" from ERP_Dondathang_SANPHAM a inner Join SanPham b on a.SANPHAM_FK = b.PK_SEQ    " +
						"where a.Dondathang_FK = ?" +
						" order by SoTT ";
				ResultSet rs = db.getByPreparedStatement(query, new Object[]{id});
	...
	private String XuatFileExcel_Details(HttpServletResponse response, String id) throws IOException
	{
		...
		"			order by SOTT	";
				ResultSet rs = db.getByPreparedStatement(query, new Object[]{id,id});
