...
public class BCTreDonHang extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String nextJSP = "/AHF/pages/Center/TreDonHang.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(action.equals("Taomoi"))
		{
			try
			{
				...
				response.setHeader("Content-Disposition", "attachment; filename=TreDonHang.xlsm");
	...
	private void CreateStaticHeader(Workbook workbook, IStockintransit obj) throws Exception 
	{
		try{
		    ...
		    cell = cells.getCell("DE1"); 	cell.setValue("TenNhaPhanPhoi");  ReportAPI.setCellHeader(cell);
		    ...
		    cell = cells.getCell("DH1"); 	cell.setValue("NgayDonHang");  ReportAPI.setCellHeader(cell);
		    cell = cells.getCell("DI1"); 	cell.setValue("SoXuatKho");  ReportAPI.setCellHeader(cell);
		    cell = cells.getCell("DJ1"); 	cell.setValue("NgayXuatKho");  ReportAPI.setCellHeader(cell);
