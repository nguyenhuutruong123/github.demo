...
public class TinhthunhapSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	PrintWriter out;
	
    public TinhthunhapSvl() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    if(action.trim().equals("delete"))
	    {
	    	...
	    	if(!db.update("update Tinhthunhap set trangthai = '2' where pk_seq = '" + khlId + "'"))
	    	{
	    		msg = "Không thể xóa Tinhthunhap";
	    	}
	    	db.shutDown();
	    }
	    ...
	    {
	    	dbutils db = new dbutils();
	    	if(!db.update("update Tinhthunhap set trangthai = '1' where pk_seq = '" + khlId + "'"))
	    	{
	    		msg = "Không thể chốt Tinhthunhap";
	    	}
	    	db.shutDown();
	    }
	    ...
	    String nextJSP = "/AHF/pages/Center/TinhThuNhap.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    {
    		ITinhthunhap khl = new Tinhthunhap();
    		khl.createRs();
    		...
    		response.sendRedirect("/AHF/pages/Center/TinhThuNhapNew.jsp");
	    }
	    else
	    {
	    	obj = new TinhthunhapList();
		    obj.setUserId(userId);
	...
	private String getSearchQuery(HttpServletRequest request, ITinhthunhapList obj) 
	{
