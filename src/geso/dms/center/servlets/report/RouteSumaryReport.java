...
public class RouteSumaryReport extends HttpServlet {
	...
	private String setQuery(String NPPID) {
		...
		System.out.println("Tom tat tuyen ban hang : "+query);
		//return "";
		return query;
...
//	    System.out.println(userId);
		...
		String nextJSP = "/AHF/pages/Center/RouteSumaryReport.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
		    ...
		    String hoatdong = geso.dms.center.util.Utility.antiSQLInspection(request.getParameter("hoatdong"));
		    if(hoatdong==null){
		    	hoatdong = "";
		    }
		    ...
		    if(action!=null){		    	
		    	if(action.equals("create")){
			        ...
			        response.setHeader("Content-Disposition", "attachment; filename=RouteSumaryReport(tt).xls");
	...
	private void CreateHeader(Workbook workbook, int i,IRouteSumaryReport obj) throws Exception {
	    ...
	    cell.setValue("BÁO CÁO THỐNG KÊ TUYẾN ");   	
