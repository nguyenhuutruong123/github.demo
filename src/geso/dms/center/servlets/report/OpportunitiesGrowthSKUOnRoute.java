...
public class OpportunitiesGrowthSKUOnRoute extends HttpServlet {
	...
	public void setQuery(HttpServletRequest request) {
		...
		obj.setGroupfocusSKU(geso.dms.center.util.Utility.antiSQLInspection(request.getParameter("groups")));
		obj.setSalesSup(geso.dms.center.util.Utility.antiSQLInspection(request.getParameter("giamsbhs")));
		obj.setSalesRep(geso.dms.center.util.Utility.antiSQLInspection(request.getParameter("ddkds")));
		obj.setRoute(geso.dms.center.util.Utility.antiSQLInspection(request.getParameter("tuyens")));
