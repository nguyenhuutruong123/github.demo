...
public class GenerateKeys {
	...
	static String path = "D:\\WEB\\TNI\\TNI\\WebContent\\pages\\Templates";
	public static final String PUBLIC_KEY_FILE = path + "/LoiBaoCao.xls";
	public static final String PRIVATE_KEY_FILE = path + "/LoiBaoCao_NEW.xls";
