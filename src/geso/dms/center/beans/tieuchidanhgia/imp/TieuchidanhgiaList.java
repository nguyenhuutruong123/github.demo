...
import geso.dms.center.beans.tieuchidanhgia.ITieuchidanhgiaList;
import geso.dms.center.db.sql.dbutils;

public class TieuchidanhgiaList implements ITieuchidanhgiaList 
{
	String userId;
	String userTen;
	String tungay;
