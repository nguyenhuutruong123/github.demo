...
public class NhaphanphoiList extends Phan_Trang implements INhaphanphoiList
{
	...
	public void createNppBeanList(String query)
	{
		...
		//system.out.println("adad: "+dataSearch);
		db.viewQuery(query, dataSearch);
		ResultSet rs = super.createSplittingData_v2(db,50, 10, "id desc", query, this.dataSearch, "");
	...
	public void init(String search) 
	{
		...
		if (search.length() == 0)
		{
			...
			"\n a.ten as nppTen, a.diachi, a.dienthoai, d.ten as khuvuc, a.trangthai, a.trangthaidms, a.ngaytao,a.kbh_fk, " +
		...
		query+="\n and (a.isKHMT != 1 or a.isKHMT is null) AND A.PK_SEQ IN "+util.quyen_npp(userId)+" ";
