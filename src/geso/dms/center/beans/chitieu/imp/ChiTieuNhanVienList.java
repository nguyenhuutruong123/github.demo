...
public class ChiTieuNhanVienList extends Phan_Trang implements IChiTieuNhanVienList, Serializable   
{
	...
	public void init(String query)
	{
		...
		{
			sql = 
			"	select a.ma, a.pk_seq, a.Thang,a.Quy,a.nam, a.ten , a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua, isnull(a.Ky,'') as Ky   "+ 
			"		from ChiTieuNhanVien a  "+
			"		inner join NHANVIEN b on a.NGUOITAO = b.pk_seq "+ 
			"		inner join NHANVIEN c on a.NGUOISUA = c.pk_seq  "+
			"  where 1=1 and a.LoaiChiTieu='"+this.type+"' " ; 
		}
		
		System.out.println("Câu init "+sql);
		this.rsTieuchi = this.createSplittingData(super.getItems(), super.getSplittings(), "nam DESC,Thang DESC ,quy desc", sql);
	}
