...
import geso.dms.center.beans.tieuchithuong.IDieukientl4;
import geso.dms.center.beans.tieuchithuong.IDieukientlDetail;

public class Dieukientl4 implements IDieukientl4
{
	String id;
	String id1;
	String id2;
	...
	public Dieukientl4(String id4, String diengiai4, String tongluong4, String tongtien4, String thutudk4)
	{
		...
		this.pheptoan4 = pheptoan4;
		this.thutudk4 = thutudk4;
		this.dkDetail = new DieukientlDetail();
		this.dkDetail1 = new DieukientlDetail();
		this.dkDetail2 = new DieukientlDetail();
		this.dkDetail3 = new DieukientlDetail();
