...
import geso.dms.center.beans.tieuchithuong.IDieukientl2;
import geso.dms.center.beans.tieuchithuong.IDieukientlDetail;

public class Dieukientl2 implements IDieukientl2
{
	String id;
	String id1;
	String id2;
	...
	public Dieukientl2(String id2, String diengiai2, String tongluong2, String tongtien2, String thutudk2)
	{
