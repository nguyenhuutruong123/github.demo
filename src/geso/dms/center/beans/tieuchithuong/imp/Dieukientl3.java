...
import geso.dms.center.beans.tieuchithuong.IDieukientl3;
import geso.dms.center.beans.tieuchithuong.IDieukientlDetail;

public class Dieukientl3 implements IDieukientl3
{
	String id;
	String id1;
	String id2;
	...
	public Dieukientl3(String id3, String diengiai3, String tongluong3, String tongtien3, String thutudk3)
	{
		this.id = id;
		this.id1 = id1;
		this.id2 = id2;
		...
		this.pheptoan3 = tongtien3;
		this.thutudk3 = thutudk3;
