...
import geso.dms.center.beans.tieuchithuong.IDieukientl1;
import geso.dms.center.beans.tieuchithuong.IDieukientlDetail;

public class Dieukientl1 implements IDieukientl1
{
	String id;
	String id1;
	String id2;
	...
	public Dieukientl1(String id1, String diengiai1, String tongluong1, String tongtien1, String thutudk1)
	{
		this.id = id;
		this.id1 = id1;
		this.id2 = id2;
		...
		this.pheptoan1 = pheptoan1;
		this.thutudk1 = thutudk1;
	...
	public void Dieukientl1(String id1, String diengiai1, String tongluong1, String tongtien1, String thutudk1)
	{
		this.id = id;
		this.id1 = id1;
		this.id2 = id2;
