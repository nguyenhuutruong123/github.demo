...
import geso.dms.center.beans.tinhphucap.ITinhphucapList;
import geso.dms.center.db.sql.dbutils;

public class TinhphucapList implements ITinhphucapList 
{
	String userId;
	String userTen;
	String tungay;
	...
	public void init(String query) 
	{
		...
		{	
			sql = "select a.pk_seq, a.thang, a.nam, a.diengiai, a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua  " +
				  "from TinhPhuCap a inner join NHANVIEN b on a.NGUOITAO = b.pk_seq " +
