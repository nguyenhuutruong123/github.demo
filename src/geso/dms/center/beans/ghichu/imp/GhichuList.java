...
import geso.dms.center.beans.ghichu.IGhichuList;
...
public class GhichuList extends Phan_Trang implements IGhichuList, Serializable 
{
	...
	public GhichuList(String[] param)
	{
	...
	public int getLastPage() {
		...
		ResultSet rs = db.get("select count(*) as px from ghichu");
		try 
		{
			rs.next();
