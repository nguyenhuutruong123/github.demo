...
<% 
	...
	String[] spSoluongNppdat = lsxBean.getSpSoluongNppDat();
			...
			<div>
				...
				<table cellpadding="0px" cellspacing="1px" width="100%">
					<tr class="tbheader">
						...
						<th align="center" width="7%" >Số lượng NPP đặt</th>
				...
				<%
						...
						if(spMa != null)
						{
							...
							{
								String myColor= "";
								double sl = Utility.parseDouble(spSoluong[i]);
								double slNppDat = Utility.parseDouble(spSoluongNppdat[i]);
								if(sl != slNppDat)
								{
									myColor = "background-color: #33FFF0";
								}
							...
							<tr  onMouseover="ddrivetip('<%=spGhichu[i] %>', 250)"; onMouseout='hideddrivetip()'>
								...
								%>
									...
									<td > <input  type="text" name="spSoluongNppdat" value="<%= spSoluongNppdat[i] %>" style="width:96%; text-align: right;<%=myColor %>  "  readonly> </td>
									<td > <input type="text" name="soluong" value="<%= spSoluong[i] %>" style="width:96%; text-align: right;<%=myColor %>" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);"  > </td>
								...
								<% } else { %>
									...
									<td> <input type="text" name="spTonkho" value="<%= spTonkho[i] %>" style="width: 100%" readonly="readonly"> </td>
									<td> <input type="text" name="spSoluongNppdat" value="<%= spSoluongNppdat[i] %>" style="width:96%; text-align: right;"  readonly> </td>
					...
					<% for(int i = count; i < 50; i++) { %>
						...
						<tr>
							...
							<td> <input type="text" name="spSoluongNppdat" value="" style="width:96%; text-align: right;"  readonly> </td>
