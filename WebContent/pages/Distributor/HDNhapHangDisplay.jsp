...
<%@ page  import = "geso.dms.distributor.beans.hdnhaphang.IHDnhaphang" %>
...
<form id="nhaphangForm" name="nhaphangForm" method="post" action="../../HDnhaphangDisplaySvl"> 
                    	...
                    	<TR>
                        	<TD align="left" class="tbnavigation">
                            	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                                	<tr height="22">
                                    	<TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý tồn kho &gt;&nbsp;Mua hàng từ Nhà cung cấp &gt;&nbsp;Nhận hàng &gt;&nbsp;Hiển thị
        		        ...
        		        <TR ><TD >
                		    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        		<TR class = "tbdarkrow">
                            		...
                            		<TD width="30" align="left"><A href="../../HDnhaphangSvl?userId=<%=userId%>"  ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
                            ...
                            <TD width="100%" align="left">
								...
								<TR>											
								 ...
								 <TR>                                       										
                                        ...
                                        <TD  class="plainlabel">Nhập số hóa đơn </TD>
                                        <TD colspan="0" class="plainlabel"> <input type="text" name="sohoadon" id="sohoadon" value="<%=hdnhaphang.getSohoadon()%>"  style="text-align: right" >
