...
String ngaydonhang = (String)session.getAttribute("ngaychuyen"); 
if(ngaydonhang == null)
	ngaydonhang = "";
			...
			if(sp != null)
			{
				while(sp.next())
				{
							...
							|| tensp.toUpperCase().indexOf(query.toUpperCase()) >= 0 || donvi.toUpperCase().indexOf(query.toUpperCase()) >= 0 )
					{
						...
						out.print("###" + sp.getString("ma") + " - " + spTen + " [" + sp.getString("donvi") + "] [" + GiaSauCK + "] [" + sp.getDouble("thuexuat") + "] [" +  DonGia + "] [" + ptChietKhau + "] [" + sp.getString("bgId") + "]|"); //luu y: bat buoc phai co dau phan cach '|' o cuoi moi dong'
					}	
				}	
				sp.close();
			}
