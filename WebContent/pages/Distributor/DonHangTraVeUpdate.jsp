						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;<%= url %> > Cập nhật </TD>								   
							...
							while (m < size){
								sanpham = splist.get(m); 
								 %>										
								  ...
								  <%--   <%} %> --%>
								    ...
								    <TD align = "center" >
								    	<input type="text" name="dongia" readonly="readonly" value="<%= sanpham.getDongia() %>" style="width:100% ;text-align: left;">
								    </TD>
								...
								<TR class= 'tblightrow'>
								    ...
								    <TD align = "center" >
								    	<input name="dongia" type="text" readonly="readonly" value="" onkeyup="Dinhdang(this);" style="width:100% ;text-align: left;">
								    </TD>
								    <TD align = "center" >
