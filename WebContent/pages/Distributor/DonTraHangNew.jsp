                 ...
                 <TR>
										  	  	<TD class="plainlabel">File đính kèm
										  	  		...
										  	  		if(lsxBean.getFile().length > 0 ) {	
										  	  			...
										  	  			<div id="tenfilea"><p><%= lsxBean.getFile()[i] %><img src="../images/Delete20.png" onclick="Xoafile('<%= lsxBean.getFile()[i]%>')" style="cursor: pointer;" alt="Xóa" width="20" height="20" longdesc="Cap nhat" border = 0></p></div>
										  	  			<%}
									  	  			}%>
										  	  	</TD>
