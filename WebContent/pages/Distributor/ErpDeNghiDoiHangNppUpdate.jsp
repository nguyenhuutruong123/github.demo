...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Đề nghị đổi hàng > Cập nhật
        </div>
					...
					<%
						if(spRs != null)
						{
							...
							<tr>
								...
								<td><input type="text"  value="<%= formater.format(spRs.getDouble("TonKho")) %>"   name="spTONKHO" readonly="readonly" style="width: 100%; text-align: right;" > </td>
								<td>
