...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý chỉ tiêu &gt; Khai báo &gt; Khai báo ngày nghỉ
        </div>
					...
					<% 
						...
						for (int i = m; i < 31; i ++){
							...
							<%} else {%>
								<TR class= <%= darkrow%> >
							<%}%>
								<td><input name="ngay" type="text" class="days"  readonly="readonly" value=""></td>
								<td><input name="ghichu" type="text" value="" style="width: 100%"></td>
							</TR>
						<%
						m ++;
						}%>
