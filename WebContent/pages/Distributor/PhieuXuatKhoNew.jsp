...
<% ResultSet tbhRs = (ResultSet)pxkBean.getTuyenbanhang();%>
    	...
    	<legend class="legendtitle"> Phiếu xuất kho </legend>
        	...
        	<div style="float:none; width:100%" align="left">
            	<table width="100%" cellspacing="0" cellpadding="6px">
                    ...
                    <tr>
           				<td class="plainlabel">Tuyến bán hàng<FONT class="erroralert"> *</FONT></td> 
                        <td class="plainlabel">
                            <select name="tbhId" id="tbhId" onchange="submitform()">
                            	<option value="">&nbsp;</option>
                                <% if(tbhRs != null){
									  try{ while(tbhRs.next()){ 
						    			if(tbhRs.getString("tbhId").equals(pxkBean.getTbhId()  )){ %>
