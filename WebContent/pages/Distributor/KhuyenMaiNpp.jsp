...
<form name="kmForm" method="post" action="../../KhuyenmaiNppSvl"> 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr height="25px">
		<TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý tồn kho > Đơn đặt hàng > Áp khuyễn mãi > Điều chỉnh</TD>
		<TD colspan="2" align="right" class="tbnavigation">Chào mừng bạn  <%= userId %> &nbsp;</TD>
	</tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<TR class="tbdarkrow">
		<TD align="left" width="30"><A href = "../../ErpDondathangNppUpdateSvl?userId=<%= userId %>&id=<%= xlkm.getIdDonhang() %>"><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
	    ...
	    <%
	    	...
	    	while(m < listCTKM.size())
	    	{
	    		...
	    		%>
	    			...
	    			<li style="color: blue" ><%= ctkm1.getscheme() + " - " + diengiai1 %> 
