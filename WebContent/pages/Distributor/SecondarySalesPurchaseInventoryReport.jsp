					...
					<div style="width: 100%; float: none" align="left">
						<div style="width: 100%; float: none" align="left"
							...
							<TABLE width="70%" cellpadding="6" cellspacing="0">
								...
								<TR>
									<TD class="plainlabel">Tính theo giá</TD>
									<TD class="plainlabel" colspan="3">
                             ...
                             <TD class="plainlabel">Nhà phân phối</TD>
									<TD class="plainlabel"><select name="nppId" id="nppId" >
								  	...
								  	<TD class="plainlabel" colspan="2">
				  						...
				  						<input type="radio" value="0" name="loai"  />Lấy tổng
				  						<input type="radio" value="1" name="loai" checked="checked" />Lấy theo ngày nhập kho
										</TD>
                                   		</TR>
										</TABLE>
									</TD>
								...
								<%-- <TR>
									...
									<TD class="plainlabel">Hàng đang đi trên đường</TD>
									<TD class="plainlabel" colspan="3">
										<%
