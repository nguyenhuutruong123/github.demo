...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("BCThieuHangNpp","", userId);
	%>
...
String url = util.getChuyenNguUrl("BCThieuHangNpp","",nnId); 
 %>
...
<!-- END RENDER AUTO -->
	...
	<form name="frm" method="post" action="../../BCThieuHangNpp">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
	...
	<input type="hidden" name="userId" value='<%=userId%>'>
		<div id="main" style="width: 99%; padding-left: 2px">
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle"><%=ChuyenNgu.get("Mức độ cung ứng",nnId)%></legend>
