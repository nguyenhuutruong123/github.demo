...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Đề nghị đổi hàng > Hiển thị
        </div>
  ...
  <div>
  	<div align="left" id="button" style=" height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpDenghidoihangNppSvl?userId=<%= userId %>&loaidonhang=<%= lsxBean.getLoaidonhang() %>" >
        	<img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1px" longdesc="Quay ve" style="border-style:outset"></A>
        	 <A href="../../ErpDenghidoihangNppUpdateSvl?userId=<%=userId %>&dis=<%= lsxBean.getId() %>" ><img src="../images/Display20.png" alt="In" title="Xem chung tu" width="30" height="30" longdesc="In chung tu" border=1 style="border-style:outset"></A>                   
    </div>
  		<div align="right" >
