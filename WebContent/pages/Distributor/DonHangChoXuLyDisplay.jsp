...
%>
<% IDonHangChoXuLy dhBean = (IDonHangChoXuLy)s.getAttribute("dhBean");
%>
	...
	for(i=0; i < masp.length; i++)
	{
		if(masp.item(i).value != "")
		{
			...
			if(pos > 0)
			{
				...
				spGiagoc.item(i).value =DinhDangTien( sp.substring(0, parseInt(sp.indexOf("] ["))) ); 
				sp = sp.substr(parseInt(sp.indexOf("] [")) + 3);
						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý bán hàng > Đơn hàng chờ xử lý > Hiển thị </TD>								   
							   		...
							   		<TD>
										...
										<tbody id="san_pham">
												<TR class="tbheader" >
													...
													<TH width="7%">Thực đặt</TH>
													<TH width="7%">Thực giao</TH>
													...
													<TH width="7%" style="display: none" >Chiết khấu </TH> <!-- chiet khau don hang -->
							...
							while (m < size){
								...
								%>
								    ...
								    <%} %>
								    <TD align = "center" >
								    	<input name="dagiao" disabled="disabled" type="text" value="<%= sanpham.getDaGiao() %>"  style="width:100%;text-align:center; color: black;">
								    </TD>
								    
								       <TD align = "center" >
								    	<input name="conlai" disabled="disabled" type="text" value="<%= sanpham.getConLai() %>"  style="width:100%;text-align:center; color: black;">
								    </TD>								    
								    ...
								    <TD align = "center" >
								    	<input type="text" name="spGiagoc1" value="<%=formatter.format(Math.round(Double.parseDouble( sanpham.getGiagoc()))) %>" readonly style="width:100% ;text-align:right">
								    	<input type="hidden" name="spGiagoc" value="<%=formatter.format(Math.round(Double.parseDouble( sanpham.getGiagoc()))) %>" readonly style="width:100% ;text-align:right">
								    ...
								    <TD align="center" style="display: none">
								    	<input type="text" name="spchietkhauDH" value="<%= sanpham.getChietkhauDH() %>" style="width:100%;text-align:right">
								    </TD>
								    <TD align = "center" >
								    	<input type="text" name="dongia1"   <%= dhBean.getIsChiNhanh().equals("0")?"disabled=\"disabled\"":"" %>  onkeyup="Dinhdang(this)"  value="<%=formatter.format(Math.round(Double.parseDouble( sanpham.getDongia())))%>" style="width:100% ;text-align:right; color: black;">
									...
									while(count < scheme_sanpham.size())
									{
										...
										<TR class= 'tblightrow'>
									        ...
									        <TD align = "center" ><input name="slgTraKm" type="text" value="<%= formatter.format(Math.round(Double.parseDouble(tkmSp.getSoluong()))) %>" style="color:red;width:100%;text-align:right" readonly></TD>
									         ...
									         <TD align = "center" >
								    	<input name="dagiao" disabled="disabled" type="text" value="<%= tkmSp.getDaGiao() %>"  style="width:100%;text-align:center; color: black;">
								    </TD>
								    
								       <TD align = "center" >
								    	<input name="conlai" disabled="disabled" type="text" value="<%= tkmSp.getConLai() %>"  style="width:100%;text-align:center; color: black;">
								    </TD>
