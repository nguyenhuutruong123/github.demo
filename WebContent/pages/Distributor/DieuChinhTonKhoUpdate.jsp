                                ...
                                <TR>
                                    <TD align="left" class="tbnavigation">
                                       <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                           <tr height="22">
                                               <TD align="left" colspan="2" class="tbnavigation">Quản lý tồn kho > Điều chỉnh tồn kho > Cập nhật </TD>
                                            ...
                                            <TR class="tbheader" >
                                               ...
                                               <!--   <TH width="8%">Ngày nhập kho </TH> -->
    											...
    											<%	} %>
															...
															<TD>
																<input type="text" name='tonkho' value="<%= formatter.format(Math.round(Double.parseDouble(tkht[i])))%>" readonly="readonly"  onchange="Dinhdang(this)" style="width: 100%; text-align: right; border: 0"   >
															</TD>
																<TD>
															...
															<TD>
																<input type="text" name='tonkhomoi' value="<%= formatter.format(Math.round(Double.parseDouble(soluongle[i]))) %>"    style="width: 100%; text-align: right; border: 1"  onKeyPress="return submitenter(this,event);"  onchange="UpdateTonMoi(<%=i %>)" >
															</TD>
															<TD>
																<input type="text" name='dieuchinh'   value="<%= formatter.format(Math.round(Double.parseDouble(dc[i]))) %>" style="width: 100%; text-align: right;" onchange="UpdateSoLuongDieuChinh(<%=i %>)"  >
															</TD>
															<TD>
																<input type="text" name='dongia'  value="<%= formatter.format(Math.round(Double.parseDouble(giamua[i]))) %>" onchange="Dinhdang(this)" style="width: 100%; text-align: left;" readonly="readonly">
															</TD>
															<TD>
