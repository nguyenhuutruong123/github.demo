...
function replaces()
{
	...
	for(i=0; i < masp.length; i++)
	{
		if(masp.item(i).value != "")
		{
			...
			/* 	don_gia = parseFloat(gia_goc) * (1-parseFloat(ptChietkhau)/100);
				//dongia.item(i).value = DinhDangTien(roundNumber(don_gia, 0));
	...
	{    
	 ...
	 function submitformDHK()
	 { 
		 /* var donhangkhacOld = ( document.getElementById("donhangkhacOld").value == "1") ;
		 var donhangkhac = document.getElementById("donhangkhac").checked;
		 
		 if( donhangkhacOld != donhangkhac )
		 {
			 alert('Xoa');
		 } */
...
<INPUT type="hidden" id="donhangkhacOld" name="donhangkhacOld" value='<%=dhBean.getDonhangkhac() %>'>   
						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý bán hàng > Bán hàng cho khách hàng > Tạo mới </TD>								   
								...
								<TR>
									<TD align="left">						
										...
										<TABLE cellpadding = "3" cellspacing = "0" width = "100%" border = 0>
											<TR>
											  <TD style="width: 200px;" class="plainlabel">Ngày giao dịch </TD>
											  <TD class="plainlabel">
										     ...
										     <TR>
							                    ...
							                    <TD class="plainlabel" >
											  	...
											  	<TD class="plainlabel" >Loại đơn hàng </TD>	
											  	 <TD class="plainlabel" colspan="3">
					                              	<select id = "donhangkhac" name = "donhangkhac" onchange="submitformDHK();">
					                              		
					                              		<option value="0" <%= dhBean.getDonhangkhac().equals("0") ? "selected":""  %>    > Đơn hàng bình thường </option>
					                              		<option value="1" <%= dhBean.getDonhangkhac().equals("1") ? "selected":""  %>    > Đơn hàng khác </option>        
					                              		<option value="2" <%= dhBean.getDonhangkhac().equals("2") ? "selected":""  %>    > Đơn hàng comnbo </option>                              		                              	
					                              	</select>
							...
							while (m < size){
								...
								%>
								    ...
								    <TD align = "center" >
								    	<input type="text" name="spGiagoc1" value="<%=formatter2.format(Math.round(Double.parseDouble( sanpham.getGiagoc()))) %>" readonly style="width:100% ;text-align:right">
								    	<input type="hidden" name="spGiagoc" value="<%=formatter2.format(Math.round(Double.parseDouble( sanpham.getGiagoc()))) %>" readonly style="width:100% ;text-align:right">
								    ...
								    <TD align="center" style="display: none"  >
								    	...
								    	<input name="spchietkhauDH1" type="text" value="<%= dhBean.getChietkhauDH() %>"  style="width:100%;text-align:center; color: black;">
								    ...
								    <TD align="center" style="display: none" >
								    	<input name="spchietkhau1" type="text" value="<%= sanpham.getChietkhau()%>"   style="width:100%;text-align:right; color: black;">
								...
								<TR class= 'tblightrow'>
								    ...
								    <TD align="center" style="display: none" >
								      ...
								      <TD align = "center">
								    	<input <%=dhBean.getDonhangkhac().equals("0") ? "" : "disabled" %>   onchange="checkHangMau('<%=(m+i) %>')" type="checkbox" id="hangmau"  name="hangmau" value="1"  >
