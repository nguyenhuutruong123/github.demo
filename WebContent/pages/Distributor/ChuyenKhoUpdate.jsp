...
<% if(nnId == null) {
	...
	String url ="";
	if(ddhBean.getView() != null && ddhBean.getView().trim().length() >0)
...
<script>
	...
	function upload2(){// nhan nut cap nhat
		   ...
		   if(document.forms["ddhForm"].fileup.value==""){
			   ...
			   document.forms["ddhForm"].dataerror.value="Chưa tìm file đính kèm upload lên. Vui lòng chọn file đính kèm cần upload.";
		   }else{
							...
							<TD align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										...
										<TD colspan="2" align="right" class="tbnavigation">Chào mừng Cửa hàng/ KH VP <%=ddhBean.getNppTen()%>&nbsp;
										</TD>
									</tr>
								</table>
							</TD>
											  ...
											  <LEGEND class="legendtitle">&nbsp;Chuyển kho
												...
												<TABLE cellpadding=4 cellspacing=0 width="100%" border=0>
													<TR>
														...
														<TD class="plainlabel"> Ngày điều chỉnh <FONT class="erroralert"> *</FONT></TD>
														<TD class="plainlabel">
                                                   			<input readonly onchange="XoaSp_va_submit();" class="days" type="text" name="ngaydc" size="11" value="<%= ddhBean.getNgayDc() %>" >                                         
                                                		</TD>
													</TR>
													...
													<TD class="plainlabel">Kênh bán hàng<FONT class="erroralert"> *</FONT> </TD>
								  				 		<TD class="plainlabel"><SELECT name="kbhId" onchange="XoaSp_va_submit();" >
													<%  try
													{
									  						while(kbh.next())
									  						{								  			
												  ...
												  <TR class="tblightrow">
												   <TD class="plainlabel">Kho chuyển<FONT class="erroralert"> *</FONT></TD>
								  				 		<TD class="plainlabel"><SELECT name="khochuyenId" onchange="XoaSp_va_submit();" >
								  						<option value="" > </option>
													<%  try
													{
														kho.beforeFirst();
												  ...
												  <TD class="plainlabel"></TD>
										  	  	...
										  	  	<TD class="plainlabel">File đính kèm
										  	  		...
										  	  		if(ddhBean.getFile().length > 0 ) {	
										  	  			...
										  	  			<div id="tenfilea"><p><%= ddhBean.getFile()[i] %><img src="../images/Delete20.png" onclick="Xoafile('<%= ddhBean.getFile()[i]%>')" style="cursor: pointer;" alt="Xóa" width="20" height="20" longdesc="Cap nhat" border = 0>
										  	  				<img src="../images/Save20.png" onclick="LuuFile('<%= ddhBean.getFile()[i]%>')" style="cursor: pointer;" alt="Lưu File" width="20" height="20" longdesc="Lưu File" border = 0></p></p></div>
										  	  			<%}
									  	  			}%>
										  	  	</TD>
										  	  	<TD class="plainlabel"></TD>
							...
							%>
								<TR class= 'tblightrow' >
										<TD align="left" >
											...
											<input name="spMa" type="text" value="<%=sanpham.getMa() %>" onkeyup="ajax_showOptions(this,'abc',event)" style="width:100%" AUTOCOMPLETE="off">
										</TD>
										<TD align="left" >
									        <input name="spTen" type="text" value="<%=sanpham.getTen()  %>" style="width:100%" >
										</TD>
										<TD align="left" >
									        <input name="tonkho" type="text" value="<%=sanpham.getTonkho()  %>" style="width:100%" >
										</TD>
										<TD align = "center" >
									    	<input name="soluongchuan" type="text" onchange="QuyRaLe(<%= m %>);"  value="<%= sanpham.getSoluongchuan() %>"  style="width:100%;text-align:right; color: black;" onkeypress="return keypress(event);" >
									    </TD>									    								
							        	<TD align ="center" style="display:none;" >
								        	<input name="soluong"  type="text" value="<%= formatter.format(Double.parseDouble(sanpham.getSoluong().replace(",", ""))) %>" style="width:100%;text-align:right"  readonly="readonly" >
								        </TD>
										<TD align = "center" >
