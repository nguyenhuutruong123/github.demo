...
function submitform()
 ...
 function saveform()
 { 
	 /* var coderoute = document.getElementById("coderoute").value;
	 var routename = document.getElementById("routename").value;
	 
	 if (routename == null || routename.trim().length <=0 || (routename == null || routename.trim().length <=0) ) {
		 alert('Code Route và Route Name không được để trống, vui lòng kiểm tra lại!');
		 return;
	 } */	 
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền> Dữ liệu nền kinh doanh > khách hàng > Tạo mới
	   						 <TD colspan="2" align="right" class="tbnavigation">Chào mừng bạn  <%= khBean.getNppTen() %>&nbsp; </tr>
						</table>
			 		</TD>
				</TR>
			</TABLE>
				...
				<TR>
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
						 ...
						 <TR>
							    ...
							    <TD class="plainlabel" width="140px" >Tên người đại diện <FONT class="erroralert"> *</FONT></TD>
						  	  	...
						  	  	<TD colspan = "2" class="plainlabel"><INPUT type="text" name="diachi" id="diachi" value="<%= khBean.getDiachi() %>" size="40"></TD>
						</TR>
						...
						<TR>
                        		...
                        		<TD class="plainlabel">
                        			<%-- <input type="text" name="phuongxa" id="phuongxa"  value="<%=khBean.getPhuongxa()%>" > --%>
                        			<SELECT name="pxId" id="pxId" class="select2" style="width: 200px;" onChange="submitform();" >
								    <option value=""></option>
								      <%if(pxRs != null){ 
								      		try{while(pxRs.next()){ 
						  ...
						  <TR>
							...
							<TR style="display: none">
								...
								<TD class="plainlabel"><INPUT type="hidden" name="coderoute" id="coderoute" value="<%= khBean.getCoderoute() %>"></TD>
								<TD class="plainlabel">Route Name</TD>
								<TD class="plainlabel"  colspan="3"><INPUT type="hidden" name="routename" id="routename" value="<%= khBean.getRoutename()%>"></TD>
							</TR>
						...
						<TABLE width = 100% border="0" cellpadding="0" cellspacing ="0">						
							<TR>
								<TD height="100%">
									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										<TR>
											<TD width="15%" class="plainlabel required">Loại khách hàng</TD>
										...
										<TR>
										  ...
										  <TD class="plainlabel" valign="top" colspan = "3"><SELECT name="hchTen" >
										    <option value=""> </option>					
										     <% try{ while(hch.next()){ 
