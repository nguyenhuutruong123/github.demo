							...
							<TD align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										...
										<TD colspan="2" align="right" class="tbnavigation"> Nhà phân phối <%=ddhBean.getNppTen()%>&nbsp;
										</TD>
									</tr>
								</table>
							</TD>
									...
									<TR class="tbdarkrow">
										...
										<TD width="30" align="left"><A
											href="javascript: saveform()"><img
												src="../images/Save30.png" alt="Luu lai" title="lưu lại"
												...
												<TABLE cellpadding=4 cellspacing=0 width="100%" border=0>
										  	  	...
										  	  	<TD class="plainlabel">File đính kèm
										  	  		...
										  	  		if(ddhBean.getFile().length > 0 ) {	
										  	  			...
										  	  			<div id="tenfilea"><p><%= ddhBean.getFile()[i] %><img src="../images/Delete20.png" onclick="Xoafile('<%= ddhBean.getFile()[i]%>')" style="cursor: pointer;" alt="Xóa" width="20" height="20" longdesc="Cap nhat" border = 0></p></div>
										  	  			<%}
									  	  			}%>
										  	  	</TD>
										  	  	<TD class="plainlabel"></TD>
