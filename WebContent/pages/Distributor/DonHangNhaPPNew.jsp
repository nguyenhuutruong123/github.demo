...
{	 
	 ...
	 document.forms['dhForm'].action.value='new';//de serverlet hieu dc day la su kien sua don hang
     document.forms['dhForm'].submit();
}
function replaces()
{
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý bán hàng > Bán cho nhà cho NPP > Tạo mới </TD>								   
