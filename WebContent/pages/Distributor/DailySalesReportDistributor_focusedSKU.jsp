...
<%
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("DailySalesnpp_focusedSKU","", userId);
%>
...
String url = util.getChuyenNguUrl("DailySalesnpp_focusedSKU","",nnId); 
 %>
 ...
 <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
				<%System.out.println("Thang bao:..."+obj.getMsg());%>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle"><%=ChuyenNgu.get("Báo cáo doanh số SKU tập trung",nnId)%></legend>
						...
						<div style="width: 100%; float: none" align="left"
							...
							<TABLE width="70%" cellpadding="6" cellspacing="0">
								...
								<TR style="display: none">									
									<TD class="plainlabel"><%=ChuyenNgu.get("VAT",nnId)%></TD></TD>
									<TD class="plainlabel">
