...
<head>
    ...
    <script language="javascript" type="text/javascript">
		...
		{	
			...
			var soluongkho = document.getElementsByName("available");
...
<!-- END RENDER AUTO -->
	...
	<form name="pxkForm" method="post" action="../../ChuyenkhoNVUpdateSvl">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		...
		<INPUT name="nppId" type="hidden" value='<%= pxkBean.getNppId() %>'
			size="30"> <input type="hidden" name="action" value='1'>
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 50%; padding: 5px; float: left"
					class="tbnavigation">Quản lý tồn kho > Chuyển kho > Tạo mới</div>
				<div align="right" style="padding: 5px" class="tbnavigation">
					Chào mừng nhà phân phối
					<%= pxkBean.getNppTen() %>
				</div>
			</div>
			...
			<div align="left" id="button"
				...
				class="tbdarkrow">
				<A href="../../ChuyenkhoSvl?userId=<%=userId %>"> <img
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<textarea name="dataerror" style="width: 100%" rows="1"
						readonly="readonly"><%= pxkBean.getMessage() %></textarea>
					<% pxkBean.setMessage(""); %>
				</fieldset>
			</div>
				...
				<fieldset>
					...
					<div style="float: none; width: 100%" align="left">
						<table width="100%" cellspacing="0" cellpadding="6px">
							<tr>
								<td class="plainlabel" width="20%" valign="middle">Ngày
									chuyển</td>
								<td class="plainlabel"><input type="text" size="11"
									class="days" id="ngaychuyen" name="ngaychuyen"
									value="<%= pxkBean.getNgaychuyen() %>" maxlength="10" readonly />
								</td>
								<td class="plainlabel">&nbsp;</td>
							</tr>
							<tr>
								<td class="plainlabel">Nhân viên bán hàng<FONT
									class="erroralert"> *</FONT></td>
								<td class="plainlabel"><select name="nvbhId" id="nvbhId"
									onchange="submitform()">
										<option value="">&nbsp;</option>
										<% if(nvbh != null){
									  try{ while(nvbh.next()){ 
							...
							<tr>
								<td class="plainlabel">Kho chuyển<FONT class="erroralert">
										*</FONT></td>
						...
						<table width="100%" cellpadding="0px" cellspacing="1px">
							<tr>
								...
								<th class="tbheader" align="center" width="35%">Tên sản
									phẩm</th>
								<th class="tbheader" align="center" width="10%">Đơn vị tính</th>
								<th class="tbheader" align="center" width="15%">Tồn tại kho
									NPP</th>
								<th class="tbheader" align="center" width="15%">Tồn tại kho
									NVBH</th>
								<th class="tbheader" align="center" width="10%">Số lượng
									chuyển</th>
                    	...
                    	%>
							<tr class="tbdarkrow">
								<td><input type="hidden" name="spIds"
									value="<%= spRs.getString("spId") %>"> <input
									type="text" value="<%= spRs.getString("spMa") %>"
									style="width: 100%" disabled="disabled">
								</td>
								<td><input type="text" name="spTen"
									value="<%= spRs.getString("spTen") %>" style="width: 100%"
									disabled="disabled">
								</td>
								<td><input type="text"
									value="<%= spRs.getString("donvi") %>" style="width: 100%"
									disabled="disabled">
								</td>
								<td><input type="text" name="available"
									value="<%= formatter.format(spRs.getDouble("available")) %>"
									style="width: 100%; text-align: right;" disabled="disabled">
								</td>
								<td><input type="text"
									value="<%= formatter.format(spRs.getDouble("avaiNVBH")) %>"
									style="width: 100%; text-align: right;" disabled="disabled">
								</td>
								<td>
					...
					<div align="left"
						style="width: 100%; float: none; clear: none; display: none"
						id="sanphamList"></div>
				</fieldset>
			</div>
		</div>
