					...
					<TR height="22">
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation"> &nbsp;Quản lý tồn kho > Trả đơn hàng > Hiển thị </TD>								   
									...
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
										   ...
										   <%--  <TD width="30" align="left"> 
								    			    <div id="btnprint">
								    			   <A href="../../XuatKhoPdfSvl?userId=<%=userId%>&pdf=<%=dtdhBean.getId()%>&type=TraDh" ><img src="../images/Printer30.png" alt="In" title="In chung tu" longdesc="In chung tu" border=1 style="border-style:outset"></A> 
								    				</div>
							    			</TD>	    		 --%>
										</TR>
									</TABLE>
							...
							while (m < size){
								...
								<% m++; }}%>
							<TR class="tbheader" >
			           	 		<td  align="right" colspan="3"  style="color:red;font-weight: bold;font-size:1.25em"> Tổng cộng </td>
