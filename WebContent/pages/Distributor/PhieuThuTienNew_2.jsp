			  ...
			  <TR class="tblightrow">
				     <TD  class="plainlabel" colspan = 3>
				 		<a class="button2" href="javascript:noclaim()">
							<img style="top: -4px;" src="../images/button.png" alt="">Chọn khách hàng							
                ...
                <% int m = 0;
                	try{
                		if(khSelected != null){
							...
							<TD align="center"><input type ="text" size="10" name = <%="tt" + khSelected.getString("khId") %> id = <%="tt" + khSelected.getString("khId") %> value="0" onChange="SuaThuTien();"></TD>
							
					 		<TD align="center"><input type ="text" size="10" name =<%="sd" + khSelected.getString("khId") %> id =<%="sd" + khSelected.getString("khId") %> value ='<%=(-1)*Math.round(Double.parseDouble(khSelected.getString("tongno")))%>' readonly ></TD>
