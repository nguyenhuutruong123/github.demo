									...
									{ 
										...
										<TD align="center" valign="middle">
											<% if(ckRs.getString("trangthai").equals("0")) {%>
												...
												<A href = "../../TrahangNVSvl?userId=<%=userId%>&delete=<%= ckRs.getString("pk_seq") %>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa phiếu chuyển kho này?')) return false;"></A>&nbsp;
												<A href = "../../TrahangNVSvl?userId=<%=userId%>&chotphieu=<%= ckRs.getString("pk_seq") %>" > <img src="../images/Chot.png" alt="Chot phieu chuyen" width="20" height="20" longdesc="Chot phieu chuyen" border = 0 onclick="if(!confirm('Bạn có muốn chốt phiếu chuyển kho này?')) return false; "></A>
											<%}else{ %>
