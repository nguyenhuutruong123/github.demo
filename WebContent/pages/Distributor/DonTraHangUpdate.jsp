...
<script language="javascript" type="text/javascript">
	...
	function upload2(){// nhan nut cap nhat
		   ...
		   if(document.forms["hctmhForm"].fileup.value==""){
			   ...
			   document.forms["hctmhForm"].dataerror.value="Chưa tìm file đính kèm upload lên. Vui lòng chọn file đính kèm cần upload.";
		   }else{
	...
	function LuuFile(name)
	{
		 ...
		 document.forms["hctmhForm"].tenfile.value = name;
		 document.forms["hctmhForm"].submit();
	}
	function replaces()
	{
    	...
    	<legend class="legendtitle">Trả hàng </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
               <TR>
                    ...
                    <%-- <TD class="plainlabel" >Số hóa đơn  <FONT class="erroralert"> *</FONT>   </TD>
                ...
                <TR  >
                 ...
                 <TR>
					<TD class="plainlabel">Sản phẩm Upload</TD>
					<TD class="plainlabel" colspan="3">
                   ...
                   <TR>
										  	  	<TD class="plainlabel">File đính kèm
										  	  		...
										  	  		if(lsxBean.getFile().length > 0 ) {	
										  	  			...
										  	  			<div id="tenfilea"><p><%= lsxBean.getFile()[i] %><img src="../images/Delete20.png" onclick="Xoafile('<%= lsxBean.getFile()[i]%>')" style="cursor: pointer;" alt="Xóa" width="20" height="20" longdesc="Cap nhat" border = 0>
										  	  		<img src="../images/Save20.png" onclick="LuuFile('<%= lsxBean.getFile()[i]%>')" style="cursor: pointer;" alt="Lưu File" width="20" height="20" longdesc="Lưu File" border = 0></p></div>
										  	  			<%}
									  	  			}%>
										  	  	</TD>
										  	  	<TD class="plainlabel"></TD>
