    ...
    <fieldset>
    	<legend class="legendtitle">Xuất kho </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                    <%-- <TD class="plainlabel" style="color: red;" valign="top">Kênh bán hàng </TD>
                    <TD class="plainlabel" valign="top" >
                    	<input type="text"  readonly="readonly" name="kenh" value="<%= lsxBean.getKbhTen() %>"/>
                    </TD>     --%>              
                    <TD class="plainlabel" >Số chứng từ </TD>
                    <TD class="plainlabel" colspan="3" >
                    <% 
                    if(lsxBean.getLoai().trim().equals("0"))
                    {
                    	if(lsxBean.getSohoadon() != null && lsxBean.getSohoadon().length() > 0){ %>
                    	<input type="text" readonly="readonly" name="sohoadon" id="sohoadon" value="<%= lsxBean.getSohoadon() %>" style="text-align: right;"  />
                      <%} else{%>
                    	<input type="text" name="sohoadon" id="sohoadon" value="<%= lsxBean.getSohoadon() %>" style="text-align: right;"  />
                      <%}
                    } else { %>
                     	<input type="text" name="sohoadon" id="sohoadon" value="<%= lsxBean.getSohoadon() %>" style="text-align: right;"  />
                      <% } %>
                ...
                <TR>
              	...
              	<TR>
                    ...
                    <TD class="plainlabel" colspan="3" >
                    	<input type="text" name="ghichu" value="<%= lsxBean.getGhichu() %>" style="text-align: left;" />

                    </TD>
                </TR>
                <TR>
                    <TD class="plainlabel" >Ghi chú TT</TD>
                    <TD class="plainlabel" colspan="3" >
			...
			<table cellpadding="0px" cellspacing="1px" width="100%">
				<tr class="tbheader">
					...
					<th align="center" width="12%" >Mã chương trình</th>
