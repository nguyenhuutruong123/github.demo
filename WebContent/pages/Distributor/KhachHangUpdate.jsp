			...
			<TR ><TD >
				<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
					<TR class = "tbdarkrow">
					    ...
					    <%if(!khBean.getIsduyet().equals("1")){%>
					    </TD>
					    					   					  <TD width="30" align="left"> <A href="javascript:duyet()" ><IMG src="../images/Chot.png" title="Duyet" alt="Duyet" border = "1"  style="border-style:outset"></A>
					    		    <TD width="2" align="left" ></TD>
					    		    					    <%}%>
