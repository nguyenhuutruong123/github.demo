                                ...
                                <TR>
                                    <TD align="left" class="tbnavigation">
                                       <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                           <tr height="22">
                                               <TD align="left" colspan="2" class="tbnavigation">Quản lý tồn kho > Điều chỉnh tồn kho > Hiển thị</TD>
                                    ...
                                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <TR class = "tbdarkrow">
                                            <TD width="30" align="left"><A href="javascript:history.back()" ><img src="../images/Back30.png" alt="Quay về"  title="Quay về" border="1" longdesc="Quay về" style="border-style:outset"></A></TD>
                                          	<TD align="left">&nbsp; 
                                             	<A href="javascript:ExportExcel()"> <IMG width="30px" height="30px" src="../images/excel.gif" title="Xuất Excel" alt="Xuất Excel" border="1px" style="border-style: outset"></A>
                                            </TD>
                                        </TR>
                                    </TABLE>
                                </TD></TR>
