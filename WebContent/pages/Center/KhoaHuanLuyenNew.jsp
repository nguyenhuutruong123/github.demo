...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function save()
	{
	  ...
	  if( tieude == '' )
	  {
		  alert("Vui lòng nhập tiêu đề khóa huấn luyện");
		  return;
	  }
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý nhân sự > Khai báo > Khóa huấn luyện / Kỹ năng > Tạo mới</TD> 
				...
				<TR>
				  <TD height="100%" width="100%">
                    ...
                    <TR class="tbheader">
                        ...
                        <TH align="left" width="30%"> Tên GSBH </TH>
                    ...
                    <TR class="tbheader">
                        ...
                        <TH align="left" width="30%"> Tên DDKD </TH>
                        <TH align="center" width="10%"> Điện thoại</TH>
                        <TH align="left" width="40%" > Nhà phân phối</TH>
