								...
								<TR ><TD >
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
								    		...
								    		<TD align="left" >
								  				<A href="../../InBangKepIPdfSvl?userId=<%=userId%>&excel=<%=dhBean.getId()%>" ><img src="../images/excel.gif" alt="Thông tin đơn hàng" title="Thông tin đơn hàng" longdesc="Thông tin đơn hàng"  border="1px" height=30 width=30 ></A>
								    		</TD>
										</TR>
									</TABLE>
								</TD></TR>
							...
							<% if(!dhBean.getTrangthai().equals("3")){
								...
								<TR class= 'tblightrow'>
							        ...
							        <input name="soluong" type="text" value="" style="width:100%; text-align:right" onkeypress="return keypress(event);" AUTOCOMPLETE="off"></TD>
								     ...
								     <TD align = "center" >
								    	<input name="quydoi" disabled="disabled" type="text" value=""  style="width:100%;text-align:center; color: black;">
