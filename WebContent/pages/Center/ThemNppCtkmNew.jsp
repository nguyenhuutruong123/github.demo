			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
				...
				<TR>
					<TD height="100%" width="100%">
						<FIELDSET >
							<LEGEND class="legendtitle" style="color:black"><%=ChuyenNgu.get("Thông tin thêm nhà phân phối chương trình khuyến mãi",nnId) %></LEGEND>
							<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">

								<TR>
									<TD class="plainlabel"  width="120px"><%=ChuyenNgu.get("Ghi chú",nnId) %></TD>
									...
									<TR>													
												<td width="9%" class="plainlabel"><%=ChuyenNgu.get("Nhà phân phối",nnId) %></td>
					...
					<tr class="tbheader">
						<th align="center" width="15%" ><%=ChuyenNgu.get("Scheme",nnId) %></th>
						<th align="center" width="45%" ><%=ChuyenNgu.get("Diễn giải",nnId) %></th>
						<th align="center" width="10%" > <%=ChuyenNgu.get("Ngân sách",nnId) %></th>
					</tr>
