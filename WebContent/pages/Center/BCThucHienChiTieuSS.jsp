...
<form name="frm" method="post" action="../../BCThucHienChiTieuSS">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		<input type="hidden" name="action" value='1'> 
		<input type="hidden" name="userId" value='<%=obj.getuserId()%>'>
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Quản lý chỉ tiêu &#62; Báo cáo &#62; Thực hiên chỉ tiêu SS TH</div>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Thực hiện chỉ tiêu của GSBH </legend>
					<div style="width: 100%; float: none" align="left">
						<div style="width: 100%; float: none" align="left"
							...
							<TABLE width="70%" cellpadding="6" cellspacing="0">
									...
									<TD class="plainlabel">
									 <select name="tuthang"  style="width :50px" class="notuseselect2">
									...
									<select name="tunam"  style="width :50px" class="notuseselect2">
									<option value=0> </option>  
									<%
									...
									<TD class="plainlabel">
									 <select name="denthang" style="width :50px" class="notuseselect2">
									<option value=0> </option>  
									<%
									...
									<select name="dennam"  style="width :50px" class="notuseselect2">
									<option value=0> </option>  
									<%
