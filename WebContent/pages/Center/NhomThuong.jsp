					...
					<TABLE class="" width="100%">
						<TR>
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
								<TR class="tbheader">
									<TH width="5%"><%=ChuyenNgu.get("Mã nhóm",nnId) %></TH>
									<TH width="16%"><%=ChuyenNgu.get("Tên nhóm",nnId) %></TH>
									<TH width="9%"><%=ChuyenNgu.get("Diễn giải",nnId) %> </TH>
									<TH width="8%"><%=ChuyenNgu.get("Từ ngày",nnId) %> </TH>
									<TH width="8%"><%=ChuyenNgu.get("Đến ngày",nnId) %> </TH>
									...
									<TH width="20%"><%=ChuyenNgu.get("Tác vụ",nnId) %></TH>
								</TR>
						<% 
