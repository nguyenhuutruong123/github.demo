							...
							<TR>
								<TD>
									...
									<TABLE border="0" width="100%" cellpadding="4" cellspacing="0">
										<TR>
											<TD width="25%" class="plainlabel required" >Mã sản phẩm <FONT class="erroralert"> </FONT></TD>
											<TD width="20%" class="plainlabel"><INPUT type="text" readonly="readonly" name="masp" id="masp" style="width:300px" value = '<%=spBean.getMasp() %>'></TD>
										...
										<TR>
											<TD class="plainlabel required">Tên sản phẩm <FONT class="erroralert"></FONT></TD>
										  	<TD colspan = "3" class="plainlabel"><input readonly="readonly" name="tensp" id="tensp" type="text" style="width:500px" value = '<%=spBean.getTen() %>'></TD>
						  				</TR>
										<TR>
											<TD class="plainlabel required">Tên sản phẩm viết tắt <FONT class="erroralert"></FONT></TD>
										...
										<TR>
							  				<TD class="plainlabel required">Đơn vị đo lường <FONT class="erroralert"> </FONT></TD>
										...
										<TR>
										  <TD class="plainlabel required">Đơn vị kinh doanh<FONT class="erroralert"></FONT></TD>
										  <TD colspan="3" class="plainlabel">
									  ...
									  <TR>
										  <TD class="plainlabel required">Ngành hàng<FONT class="erroralert"></FONT></TD>
										  <TD colspan="3" class="plainlabel">
										...
										<TR>
											  <TD class="plainlabel required">Nhãn hàng <FONT class="erroralert"></FONT></TD>
											  <TD colspan="3" class="plainlabel">
											  		<% if (dvkdId.length()>0){ %>
										  ...
										  <TR>
											  <TD class="plainlabel required">Chủng loại<FONT class="erroralert"> </FONT></TD>
											  <TD colspan="3" class="plainlabel">
