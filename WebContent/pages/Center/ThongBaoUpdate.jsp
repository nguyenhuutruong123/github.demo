						 ...
						 <TR>
						  ...
						  <TR>
							 ...
							 <% if(thongbao.getDoiTac().equals("1")) { %>
								  		<input type="checkbox" name="doitac" checked="checked" value="1" onchange="LocNhanVien()" ><i>Nhà phân phối</i>
								  	<% } else { %>
								  		<input type="checkbox" name="doitac" value="1" onchange="LocNhanVien()" ><i>Nhà phân phối</i>
								  	<% } %>
							 </TD>
		                  			...
		                  			<div style="font-size: 1.0em; font-weight: 500" >
		                  				<TABLE width="100%" cellspacing="1" cellpadding="4">
		                  					...
		                  					<TR>
		                  						...
		                  						<TH width="10%" align="center" class="plainlabel" >Chọn tất cả <input type="checkbox" id='chkAll' onchange="sellectAll('chkAll', 'nvIds');"   > </TH>
		                  					</TR>
		                  					
		                  						<TR >
		                  						<td class="plainlabel" colspan="3" > NHÂN VIÊN ĐĂNG NHẬP </td>
		                  		
		                  						<TH width="10%" align="center" class="plainlabel" >Chọn <input type="checkbox" id='chk' onchange="sellectAll2('chk', 'nvIds');"   > </TH>
		                  					</TR>
		                  					...
		                  					<TR >
		                  						<td class="plainlabel" colspan="3" > User nhà phân phối </td>
		                  						<TH width="10%" align="center" class="plainlabel" >Chọn <input type="checkbox" id='chk1' onchange="sellectAll2('chk1', 'nppids');"   > </TH>
		                  					</TR>
		                  				...
		                  				<TR >
		                  						<td class="plainlabel" colspan="3"> Nhân viên bán hàng </td>
		                  							<TH width="10%" align="center" class="plainlabel" >Chọn <input type="checkbox" id='chk2' onchange="sellectAll2('chk2', 'ddkdIds');"   > </TH>
		                  					</TR>
