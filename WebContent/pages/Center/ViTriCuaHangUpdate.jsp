...
<SCRIPT language="javascript" type="text/javascript">
 ...
 function saveform()
 {
	 if(document.getElementById("vitricuahang").value=="")
		 {
		 	alert("Vui lòng nhập vào Vị trí");
		 	return;
		 }
					...
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">
							   		Dữ liệu nền &gt; Kinh doanh &gt; Vị trí &gt; Cập nhật </TD>
				  	...
				  	<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
									<TR>
									  <TD width="24%" class="plainlabel required" >Vị trí<FONT class="erroralert"></FONT></TD>
									...
									<TR>
									  ...
									  <TD class="plainlabel" ><INPUT name="diengiai" id="diengiai"
