<%@page import="geso.dms.center.beans.giamsatbanhang.imp.Giamsatbanhang"%>
...
<% 	
Giamsatbanhang ddkdBean = (Giamsatbanhang)session.getAttribute("ddkdBean"); 
%>
...
<form name ="nspForm" method="post" action="../../GiamsatbanhangUploadSvl" >
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">
							 		&nbsp;Dữ liệu nền &gt; Kinh doanh &gt; Giám sát bán hàng > Upload ảnh </TD> 
				...
				<TR>
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<TR>
						  	  	<TD class="plainlabel">Mã GSBH <FONT class="erroralert"> *</FONT> </TD>
						  	  	<TD class="plainlabel" >
						  	  	<INPUT type="text" name="Ma" style="width:200px" value='<%=ddkdBean.getSmartId()%>'>
						  	  	</TD>
						  	</TR>
						  	<TR>  	
						  	  <TD class="plainlabel">Tên GSBH <FONT class="erroralert"> *</FONT> </TD>
						  	  	<TD class="plainlabel" >
