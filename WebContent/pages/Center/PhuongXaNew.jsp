				  	...
				  	<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
									...
									<TR>
								    <TD width="20%" class="plainlabel"><%=ChuyenNgu.get("Tỉnh thành",nnId) %><FONT class="erroralert"> *</FONT></TD>
									...
									<TR>
										<TD width="20%" class="plainlabel"><%=ChuyenNgu.get("Quận huyện",nnId) %><FONT class="erroralert"> *</FONT></TD>
