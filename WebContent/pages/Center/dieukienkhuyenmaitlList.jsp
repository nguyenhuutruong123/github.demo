...
<%
    ...
    else
    {
    	...
    	else
    	{
    	    ...
    	    command = command + " from dieukienkhuyenmaitl where nguoitao is not null and pk_seq in (select dieukienkhuyenmai_fk from DIEUKIENKMtl_SANPHAM where sanpham_fk in " + Ult.quyen_sanpham(userId) + ")";
