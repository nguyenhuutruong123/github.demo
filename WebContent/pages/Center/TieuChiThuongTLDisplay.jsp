				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Khuyến mại tích lũy theo mức > Hiển thị</TD> 
								...
								<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
				                    ...
				                    if(obj.getSanphamMuaRs() != null)
				                    {
					                   ...
					                   { %>
					                    	<tr>
					                    		<td>
					                    			<input type="text" name="maspMua" style="width: 100%" value="<%= obj.getSanphamMuaRs().getString("ma") %>"  onkeyup="ajax_showOptions(this,'abc',event)"  AUTOCOMPLETE="off" >
					                    		</td>
					                    		<td>
					                    			<input type="text" name="tenspMua" style="width: 100%" readonly="readonly" value="<%= obj.getSanphamMuaRs().getString("ten") %>" >
					                    		</td>	
