...
<%	
	...
	Hashtable<String, Long> dataNHD = (Hashtable<String, Long>)obj.getNVNgungHoatDong();
 %>
...
<!-- END RENDER AUTO -->
	...
	<form name="frm" method="post" action="../../BCChartTongNhanVien">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Báo cáo quản trị > Báo cáo đồ thị > Tổng nhân viên </div>
				...
				<fieldset>
					...
					<div style="width: 100%; float: none" align="left">
							...
							<TABLE width="70%" cellpadding="6" cellspacing="0">
								<TR>
									...
									<TD class="plainlabel" colspan="3">
										<select name="muclay" id="muclay" onchange="submitform();">
										<% if(obj.getMuclay().equals("0")) { %>
								...
								<TR>
								  	<TD class="plainlabel"> </TD>
										...
										<input type="checkbox" name="trangthai" checked="checked" value="1" ><i>Chỉ lấy nhân viên đang hoạt động</i> 
									<%} else { %>
										<input type="checkbox" name="trangthai" value="1" ><i>Chỉ lấy nhân viên đang hoạt động</i> 
									<% } %>
							  	  	</TD>
							  	</TR>
								<TR>
						...
						<div class="main">
								<table id='myTable'>
								<% if(obj.getMuclay().equals("0")) { %>
									<caption align="left" >Tổng nhân viên theo khu vực</caption>
								<% } else { %> 
									<caption align="left" >Tổng nhân viên theo vùng</caption>
								<%} %>
									<thead>
										<tr>
											<th></th>
									...
									<tbody>
										...
										<tr>
											...
											<%  
												Enumeration<String> keyssss = dataNHD.keys(); 
												while(keyssss.hasMoreElements())
												{
													String key = keyssss.nextElement(); %> 
													<td><%= dataNHD.get(key) %></td>
											<% } %>
										</tr>
										<% } %>
									</tbody>
