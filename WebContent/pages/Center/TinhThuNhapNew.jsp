				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý nhân sự > Khai báo > Tính thu nhập > Tạo mới</TD> 
                        	...
                        	<tr>
                        		...
                        		<td align="center">
                        			<a class="apchokhuvuc<%= i %>" href="#">
	           	 							&nbsp; <img alt="Áp cho khu vực" src="../images/vitriluu.png" title="Chọn Khu vực "></a>
