				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Khai báo CK đặt hàng > Hiển thị</TD> 
						...
						<div class="panes">
							...
							<div id="tabTieuchi" class="tab_content">
								...
								<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
									...
									<tr>
										<td>
											<input type="text" name="diengiaiMucVuot" value="Mức vượt quy định"  readonly="readonly" >
										</td>
										<td>
											<input type="text" value=">" style="text-align: center;" readonly="readonly" >
										</td>
										<td>
											<input type="text" name="mucVuot" value="<%= obj.getMucvuot() %>" style="text-align: right;" onkeyup="FormatNumber(this);" onkeypress="return keypress(event);" readonly="readonly">
										</td>
										<td>
											<input type="text" name="chietkhauMucVuot" value="<%= obj.getCKMucvuot() %>" style="text-align: right;"  onkeypress="return keypress(event);" readonly="readonly">
										</td>
								...
								<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
				                    <tr>
				                		<td style="font-size: 12px; padding: 8px; " colspan="3" >Ngành hàng &nbsp;&nbsp;   
				                			...
				                			<select name="nganhhangId" style="width: 200px;" >
												<option value="" ></option>
												<%
  													if(nganhhangRs != null) 
  													{ 
				                	...
				                	Nhãn hàng
				                		&nbsp;&nbsp; 
				                			<select name="nhanhangId" style="width: 200px;" >
												<option value="" ></option>
												<%
 													if(nhanhangRs != null) 
 													{ 
				                	...
				                	Nhóm sản phẩm
				                		&nbsp;&nbsp; 
				                			<select name="nhomspId" style="width: 200px;">
												<option value="" ></option>
												<%
 													if(nhomspRs != null) 
 													{ 
								...
								<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
				                   <tr>
				                		<td style="font-size: 12px; padding: 8px; " colspan="3" >Vùng &nbsp;&nbsp;   
				                			...
				                			<select name="vungId" style="width: 200px;">
												<option value="" ></option>
												<%
  													if(vungRs != null) 
  													{ 
				                	...
				                	Khu vực
				                		&nbsp;&nbsp; 
				                			<select name="khuvucId" style="width: 200px;">
												<option value="" ></option>
												<%
 													if(kvRs != null) 
 													{ 
