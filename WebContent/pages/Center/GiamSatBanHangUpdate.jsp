								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;
											<%=url%> > <%=ChuyenNgu.get("Cập nhật", nnId)%>
							...
							<TD height="100%" width="100%">
								<FIELDSET>
									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										...
										<TR>
											<TD width="20%" class="plainlabel"><%=ChuyenNgu.get("Tên", nnId)%>
										...
										<TR class="plainlabel">
											<TD width="20%" class="plainlabel"><%=ChuyenNgu.get("Mã", nnId)%>
												<FONT class="erroralert"> *</FONT></TD>
										...
										<TR>
											<TD width="15%" class="plainlabel"><%=ChuyenNgu.get("Địa chỉ", nnId)%>
												<FONT class="erroralert">*</FONT></TD>
										...
										<TR>
											<TD class="plainlabel"><%=ChuyenNgu.get("Quê quán", nnId)%><FONT
												class="erroralert"> </FONT></TD>
										...
										<TR>
											<%-- <TD class="plainlabel"><%=ChuyenNgu.get("Tên đăng nhập", nnId)%>
												<FONT class="erroralert"> *</FONT></TD>
											<TD class="plainlabel"><INPUT type="text"
										...
										<TR>
											<TD class="plainlabel"><%=ChuyenNgu.get("Điện thoại", nnId)%>
												<FONT class="erroralert"> *</FONT></TD>
											<TD class="plainlabel"><INPUT type="text"
											...
											<TD class="plainlabel"><%=ChuyenNgu.get("Đơn vị kinh doanh", nnId)%>
												<FONT class="erroralert">*</FONT></TD>
										...
										<TR>
											<TD class="plainlabel" style="display: none"><%=ChuyenNgu.get("Địa bàn", nnId)%>
												<FONT class="erroralert"> *</FONT></TD>
										...
										<tr>
											...
											<TD class="plainlabel"><%=ChuyenNgu.get("Khu vực", nnId)%><FONT
												class="erroralert"> *</FONT></TD>
											<TD class="plainlabel"><a href="" id="khuvuc"
												rel="subcontentSp"> &nbsp; <img
													alt="<%=ChuyenNgu.get("Khu vực", nnId)%>"
									...
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="6">
										<tbody id="tb_npp">
											...
											<TR>
											 ...
											 %>
								<FIELDSET>
									<LEGEND class="legendtitle" style="color: black">Nhà
										phân phối quản lý</LEGEND>
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="6">
										<tbody id="tb_npp">
											<TR class="tbheader">
