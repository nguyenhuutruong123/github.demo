		...
		<TD colspan="4" align='left' valign='top' bgcolor="#ffffff">
			...
			<TABLE width="100%" border="0" cellpadding="3" cellspacing="0">
				<TR ><TD >
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
							<TD width="30" align="left"><A href="../../KeHoachNhanVienSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Trỏ lại"  title="Trở lại" border="1" longdesc="Trở lại" style="border-style:outset"></A></TD>
			...
			<TABLE width = 100% cellpadding = "3" cellspacing = "0" border = "0">
			  	<TR>
					...
					<tr>
					   <TD align="left" colspan="4" class="legendtitle">
							<FIELDSET>
							<LEGEND class="legendtitle">Kế hoạch nhân viên</LEGEND>
							<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
								<TR>
								  <TD width="24%" class="plainlabel" ><%=ChuyenNgu.get("Nhân viên",nnId) %></TD>
								...
								<TR>
								  <TD class="plainlabel" ><%=ChuyenNgu.get("Năm",nnId) %> <FONT class="erroralert">*</FONT></TD>
								  <TD width="70%" class="plainlabel" >
					...
					<TR>
						<TD align="left" colspan="4" class="legendtitle">
							<FIELDSET>
							<LEGEND class="legendtitle">Chi tiết</LEGEND>
							<TABLE class="" width="100%" border="0" cellpadding="0" cellspacing="0">
								<TR>
									<TD width="98%">
										<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
											<TR class="tbheader">
												<TH width="5%"><%=ChuyenNgu.get("Ngày",nnId) %></TH>
												<TH width="15%"><%=ChuyenNgu.get("Tác vụ",nnId) %></TH>
											    <TH width="80%"><%=ChuyenNgu.get("Nội dung",nnId) %></TH>
											</TR>
								<% 
