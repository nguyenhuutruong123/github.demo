...
<SCRIPT language="javascript" type="text/javascript">
 ...
 <script language="javascript" type="text/javascript">
	...
	{  
		...
		//alert('in:'+ stt +';' + makh +';'+ smartid +';'+ tenkh +';'+ diachi);
	...
	{	
		...
		for(i=0; i < tbh_khcdpt.length; i++)
		{
			...
			if(tbh_khcdpt.item(i).checked)
			{
				...
				addRow('kh_tbh_dpt', tbh_khdpt.length+1, makh, smartid, tenkh, diachi);
				...
				<TR>
					<TD align="left" class="tbnavigation">
					   <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <TR height="22">
						  	<TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền &gt;Dữ liệu kinh doanh &gt; Kế hoạch bán hàng > Cập nhật
						...
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR class = "tbdarkrow">
								...
								<TD width="2" align="left" ></TD>
								 <%if(!tbhBean.getIsDisplay().endsWith("1")){ %>
					...
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<TR>
							...
							<tbody id="kh_tbh_dpt">
							    ...
							    <input name="thutu" id="thutu" type="text" value="<%=i+1 %>" size="5" style="width: 100%"></TD>
