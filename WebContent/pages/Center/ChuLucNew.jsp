						...
						<TR>
							<TD align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý chỉ tiêu > Chỉ tiêu nhân viên > Thưởng sản phẩm chủ lực > Tạo mới</TD>
									...
									<div id="tabNV">
											<TABLE  id="tableNv" class="tabledetail" width="1366px" border="0" cellspacing="1px" cellpadding="0px">
											  <thead>	<TR class="tbheader">
													<td align="center" width="5%">Mã</td>
													<td align="center" width="25%">Tên</td>
													<%
