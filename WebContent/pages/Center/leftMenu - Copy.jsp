...
<ul id="theMenu">
	...
	<h3 class="head"><a href="" class="head">Dữ liệu nền
	</a></h3>
	<ul style="display: block;">
		<li>
		<ul id="xtraMenu1">
			<li>
			<h4 class="head" id="dlncbId"><a href="">Cơ bản </a></h4>
			<ul style="display: none;">
				...
				<h5 class="head" id="ddkdId"><a
					...
					target="content">Khóa huấn luyện / Kỹ năng</a></h5>
				<%} %>
				</li>
			...
			<li>
			<h4 class="head" id="dlnspId"><a href="">Sản phẩm</a></h4>
			<ul style="display: none;">
				<li>
				<%if(mang[5]==1){ %>
			...
			<ul style="display: none;">
				...
				<h5 class="head" id="nppId"><a
					...
					target="content">Nhà phân phối ERP </a></h5>
				<%} %>
				</li>
				      ...
				      <li>
					      <%if(mang[79]==1){ %>
	            <h5 class="head" ><a
	            href="../../BmSvl?userId=<%=userId %>;userTen=<%= userTen %>" target="content">Giám đốc miền</a></h5>
	  				 <%} %>
     				 </li>
				 <li>
				       <%if(mang[80]==1){ %>
				...
				<h5 class="head" id="nkhId"><a
					...
					target="content">Nhóm khách hàng</a></h5>
				<%} %>
				</li>
	...
	<ul style="display: block;">
		...
		<ul id="xtraMenu">
			...
			<%if(mang[74]==1){ %>
			<h5 class="head"><a
				href="../../ThucDatVaChiTieuSKUIn?userId=<%=userId %>" target="content">Thực đạt & chỉ tiêu SKU</a></h5>
			<%} %>
			</li>
			...
			<%if(mang[25]==1){ %>
			<h5 class="head"><a
				href="../../DailySalesSvl?userId=<%=userId %>" target="content">Thực đạt & chỉ tiêu NPP</a></h5>
			<%} %>
			</li>
	...
	<ul style="display: block;">
		...
		<ul id="xtraMenu2">
			...
			<%if(mang[28]==1){ %>
			<li>
			<h4 class="head" id="dlncbId"><a href="">Duyệt hàng
			trả về NPP </a></h4>
			<ul style="display: none;">
				<li>
				<h5 class="head" id="htNppId"><a
	...
	<ul style="display: block;">
		...
		<ul id="xtraMenu4">
			...
			<%if(mang[40]==1){ %>
			<h5 class="head"><a
				href="../../nhomkhachhangkmSvl?userId=<%=userId %>" target="content">Nhóm khách hàng KM</a></h5>
			<%} %>
			</li>
			...
			<li>
			<h4 class="head" id=""><a href="" target="">Báo cáo</a></h4>
			<ul>
				<li>
				<%if(mang[46]==1){ %>
				<h5 class="head" id=""><a href="../../UsingPromoTT?userId=<%= userId %>" target="content">Sử dụng và chi trả KM</a></h5>
				<%} %>
				</li>
	...
	<li style="position: static;">
	<h3 class="head "><a href="">Quản lý trưng bày</a></h3>
	<ul style="display: block;">
		<li>
		<%if(mang[49]==1){ %>
		<h5 class="head" id=""><a
		...
		<%if(mang[76]==1){ %>
		<h5 class="head" id=""><a
			href="../../MokhaibaotrungbaySvl?userId=<%=userId %>" target="content">Cho phép khai báo trưng bày</a></h5>
		<%} %>
		</li>
		<li>

		<h4 class="head" id=""><a href="" >Báo cáo</a></h4>
		<ul>
			<li>
			<%if(mang[54]==1){ %>
			<h5 class="head" id=""><a
	...
	<ul style="display: block;">
		...
		<ul id="xtraMenu5">
			...
			<li>
			<h4 class="head" id=""><a href="" >Đánh giá</a></h4>
			<ul>
				<li>
				<%if(mang[56]==1){ %>
				...
				<li>
				<%if(mang[89]==1){ %>
				<h5 class="head" id=""><a href="../../BCThieuHangNppTT?userId=<%= userId %>&view=TT" target="content">Mức độ cung ứng NPP</a></h5>
				<%} %>
				</li>
				<li>
				<%if(mang[67]==1){ %>
				<h5 class="head" id=""><a href="../../BCTreDonHang?userId=<%= userId %>&view=TT" target="content">Hậu cần NPP</a></h5>
				<%} %>
				</li>
				<li>
				<%if(mang[67]==1){ %>
				<h5 class="head" id=""><a href="../../BCKhoaHuanLuyenNV?userId=<%= userId %>" target="content">Khóa huấn luyện</a></h5>
				<%} %>
				</li>
			</ul>
			</li>
			...
			<li>
			<h4 class="head" id=""><a href="">Doanh số</a></h4>
			<ul>
				<li>
				<%if(mang[64]==1){ %>
				...
				<li>
				<%if(mang[66]==1){ %>
				<h5 class="head" id=""><a href="../../BCDonHangBanTrongKy?userId=<%=userId %>&view=TT" target="content">ĐH bán trong kỳ NPP</a></h5>
				<%} %>
				</li>
				
				<li>
				<%if(mang[67]==1){ %>
				<h5 class="head" id=""><a href="../../BCPerformmanceSvl?userId=<%=userId %>&view=TT" target="content">Báo cáo performmance</a></h5>
				<%} %>
				</li>
			...
			<li>
			<h4 class="head" id=""><a href="" >Báo cáo khác</a></h4>
			<ul>
				<li>
				<%if(mang[68]==1){ %>
