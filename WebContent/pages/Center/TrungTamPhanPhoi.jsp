				   ...
				   <TD align="left" colspan="4" class="legendtitle">
						<FIELDSET>				   
							...
							<TABLE  width="100%" cellspacing="0" cellpadding = "6" >
								<TR>
									<TD width="19%" class="plainlabel" ><%=ChuyenNgu.get("Trung tâm phân phối",nnId) %></TD>
	...
	<img style="top: -4px;" src="../images/button.png" alt=""><%=ChuyenNgu.get("Nhập lại",nnId) %></a>&nbsp;&nbsp;&nbsp;&nbsp;	
		   ...
		   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
			  <TR>
			  	   <TD align="left" colspan="4" class="legendtitle">
						<FIELDSET>				   
							<LEGEND class="legendtitle">Trung tâm phân phối &nbsp;
							<%if(quyen[0]!=0){ %>
							...
							<TABLE width="100%" cellspacing="0" cellpadding="0">
								...
								<TD width="98%">
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
										<TR class="tbheader">
											<TH width="15%"><%=ChuyenNgu.get("Trung tâm phân phối",nnId) %> </TH>
										...
										<%}%>
											...
											<TD align="center">
												<TABLE border = 0 cellpadding="0" cellspacing="0">
													<TR><TD>
													<%if(quyen[2]!=0){ %>
														<A href = "../../RouterSvl?task=<%= util.dongMa(getServletContext().getInitParameter("RedirectNoScript") + "TrungtamphanphoiSvl?userId="+userId+"&update="+dvkdlist.getString("pk_seq")+"")%>"><img src="../images/Edit20.png" alt="Chinh sua" title="Cập nhật" width="20" height="20" longdesc="Chinh sua" border = 0></A>
													<%} %>
													</TD>
													<TD>&nbsp;&nbsp;</TD>
													<TD>
													<%if(quyen[1]!=0){ %>
														<A href = "../../RouterSvl?task=<%= util.dongMa(getServletContext().getInitParameter("RedirectNoScript") + "TrungtamphanphoiSvl?userId="+userId+"&delete="+dvkdlist.getString("pk_seq")+"")%>"><img src="../images/Delete20.png" alt="Xoa" title="Xóa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa trung tâm phân phối này?')) return false;"></A>
														<%} %></TD>
													</TR>
												</TABLE>											
											</TD>
