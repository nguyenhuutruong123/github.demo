...
<% 
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("LoTrinhBanHangReportNew","&view="+obj.getView()+"", userId);
...
<form name="rpForm" method="post" action="../../LoTrinhBanHangReportNew">
                               ...
                               <TR>
									<td class="plainlabel"  colspan = "2">
										...
										<a class="button3" href="javascript:exportToDetail()">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;
										<!-- <a style="display:none;" class="button3" href="javascript:exportToMCPIP()">
