...
<%	String userId = (String) session.getAttribute("userId");  
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("Dailypurchasenpp","", userId);
	%>
...
<form name="rpForm" method="post" action="../../Dailypurchasenpp">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
