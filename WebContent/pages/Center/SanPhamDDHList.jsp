			...
			if(sp != null)
			{
				while(sp.next())
				{
					...
					if(sp.getString("ma").toUpperCase().contains(query.toUpperCase()) || sp.getString("ten").toUpperCase().contains(query.toUpperCase()) )
					{
						...
						out.print("###" + sp.getString("ma") + " - " + tensp + " [" + sp.getString("donvi") + "] [" + GiaSauCK + "] [" + sp.getDouble("thuexuat") + "] [" +  DonGia + "] [" + ptChietKhau + "] [" + tonkho + "] [" + sp.getString("bgId") + "]|"); //luu y: bat buoc phai co dau phan cach '|' o cuoi moi dong'
					}	
				}	
				sp.close();
			}
