...
<%	
	...
	IChiTieuNhaphanphoi obj=(ChiTieuNhaphanphoi)session.getAttribute("obj");
	List<IChiTieuNhaphanphoi> chitietlist= obj.getChiTieu();
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("ChiTieuNhaphanphoiSvl","",userId);
...
<form name="bgstForm" method="post" action="../../ChiTieuNhaphanphoiSvl">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
                                        ...
                                        <%}%>
                                                ...
                                                <TD align="center">
                                                    ...
                                                    <TR>
                                                        ...
                                                        <A href = "../../ChiTieuNhaphanphoiNewSvl?userId=<%=userId%>&display=<%=ct.getID()%>"><img src="../images/Display20.png" alt="Hien thi" width="20" height="20" title="Hiển thị" border = 0></A>
                                                    	<%} %>
                                                     </TD>
                                                    <%
                                                    ...
                                                    <TD>
                                                        ...
                                                        <A href = "../../ChiTieuNhaphanphoiNewSvl?userId=<%=userId%>&update=<%=ct.getID()%>"><img src="../images/Edit20.png" alt="Cập nhật" width="20" height="20" title="Cập nhật" border = 0></A>
                                                    	<%} %>
                                                    </TD>
                                                    <TD>
                                                   		<%if(quyen[Utility.XOA]!=0) {%>
                                                   		<A href = "../../RouterSvl?task=<%=util.dongMa(getServletContext().getInitParameter("RedirectNoScript") + "ChiTieuNhaphanphoiSvl?userId="+userId+"&delete="+ct.getID()) %> ">
                                                        	<img src="../images/Delete20.png" alt="Xoa" width="20" height="20" title="Xóa" border=0 onclick="if(!confirm('Bạn chắc chắn muốn xóa chỉ tiêu này?')) return false;">
                                                       	</A>
                                                     	<%} %>
                                                   	</TD>
                                                     <TD>
                                                     	<%if(quyen[Utility.CHOT]!=0) {%>
                                                        <A href = "../../RouterSvl?task=<%=util.dongMa(getServletContext().getInitParameter("RedirectNoScript") + "ChiTieuNhaphanphoiSvl?userId="+userId+"&chot="+ct.getID()) %> ">
                                                        	<img src="../images/Chot.png" alt="Chốt" width="20" height="20" title="Chốt chỉ tiêu" border = 0>
                                                       	</A>
                                                     	<%} %>
                                                     </TD>
                                                     <%}else{ %>
                                                     ...
                                                     <TD>
                                                     	<%if(quyen[Utility.CHOT]!=0) {%>
                                                        <A href = "../../ChiTieuNhaphanphoiSvl?userId=<%=userId%>&unchot=<%=ct.getID()%>"><img src="../images/unChot.png" alt="Hien thi" width="20" height="20" title="Hiển thị" border = 0></A>
                                                    	<%} %>
                                                     </TD>
                                                    <%}%>
                                                    </TR></TABLE>
