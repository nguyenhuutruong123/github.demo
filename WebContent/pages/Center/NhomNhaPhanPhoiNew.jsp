...
String url = util.getChuyenNguUrl("NhomNhaPhanPhoiSvl","",nnId);	
	%>
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
				...
				<TR>
				  <TD height="100%" width="100%">
						<FIELDSET >
						<LEGEND class="legendtitle" style="color:black">Thông tin nhóm nhà phân phối </LEGEND>
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							<TR>
								<TD width="12%" class="plainlabel" ><%=ChuyenNgu.get("Mã nhóm",nnId) %><FONT class="erroralert"> </FONT></TD>
								<TD class="plainlabel">
                                <INPUT type="text" name="ma" style="width:300px" value='<%= nnppBean.getMa() %>'></TD>
							</TR>
							<TR>
							  	<TD class="plainlabel"><%=ChuyenNgu.get("Tên nhóm",nnId) %></TD>
							...
							<TR  style="display:none;">
                              ...
                              <% if (nnppBean.getLoainhom().equals("1")){ %>                                
                                	<OPTION value="1" selected ><%=ChuyenNgu.get("Nhóm nhà phân phối",nnId) %></OPTION>
                                	<OPTION value="2" ><%=ChuyenNgu.get("Nhà phân phối",nnId) %> </OPTION>
                              <%}else{ %>
                                	<OPTION value="1" ><%=ChuyenNgu.get("Nhóm nhà phân phối",nnId) %></OPTION>
                                	<OPTION value="2" selected><%=ChuyenNgu.get("Nhà phân phối",nnId) %></OPTION>
							  <%} %>                              
						  ...
						  <TR>
						  		...
						  		<TR>
						  	  	<TD class="plainlabel"><%=ChuyenNgu.get("Tình thành",nnId) %></TD>
						  	  	<TD class="plainlabel">
...
<%-- 						  		<TR>
						...
						<TABLE width="100%" border="0" cellspacing="1" cellpadding="4" >							
								<TR class="tbheader">
								<% if (nnppBean.getLoainhom().equals("1")){ %>
									<TH width="28%"><%=ChuyenNgu.get("Mã nhóm",nnId) %></TH>
									<TH width="60%"><%=ChuyenNgu.get("Tên nhóm",nnId) %></TH>
								<%}else{ %>
									<TH width="10%"><%=ChuyenNgu.get("Kênh bán hàng",nnId) %></TH>
									<TH width="10%"><%=ChuyenNgu.get("Vùng",nnId) %></TH>
									<TH width="10%"><%=ChuyenNgu.get("Khu vực",nnId) %></TH>
									<TH width="10%"><%=ChuyenNgu.get("Tỉnh thành",nnId) %></TH>
									<!-- <TH width="10%">Quận huyện</TH> -->
									<TH width="10%"><%=ChuyenNgu.get("Mã nhà phân phối",nnId) %></TH>
									<TH width="20%"><%=ChuyenNgu.get("Nhà phân phối",nnId) %></TH>
									<TH width="30%"><%=ChuyenNgu.get("Địa chỉ",nnId) %></TH>
								<%}%>								
									<TH width="15%"><%=ChuyenNgu.get("Chọn",nnId) %>
								<%	if(nnppBean.getLoainhom().equals("1")){%>			
