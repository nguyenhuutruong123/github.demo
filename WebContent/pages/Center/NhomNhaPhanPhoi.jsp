...
<!-- END RENDER AUTO -->
	...
	<form name="nppForm" method="post" action="../../NhomNhaPhanPhoiSvl">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
										...
										<TD width="100%" align="center">
											<FIELDSET>
												...
												<TABLE width="100%" cellpadding="6" cellspacing="0">
													<tr>
														<TD width="22%" class="plainlabel"><%=ChuyenNgu.get("Mã nhóm",nnId) %></TD>
													...
													<TR>
														<TD colspan="4" class="plainlabel">
															<a class="button2" href="javascript:clearform()"> <img style="top: -4px;" src="../images/button.png" alt=""><%=ChuyenNgu.get("Nhập lại",nnId) %></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												...
												<TABLE width="100%" id="table" class="tabledetail sortable" border="0" cellspacing="1" cellpadding="4">
													<thead>
														<TR class="tbheader">
															...
															<TH width="13%"><%=ChuyenNgu.get("Mã nhóm",nnId) %></TH>
 ...
 %>
																		...
																		<TD>
																			...
																			%> <A href="../../NhomNhaPhanPhoiSvl?userId=<%=userId%>&delete=<%=npplist.getString("id")%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0
																				onclick="if(!confirm('Bạn muốn xóa nhóm nhà phân phối này?')) return false;"></A>
																				<%
																			}
																		%>
																		</TD>
...
<%
	...
	obj.closeDB(); obj = null; session.setAttribute("obj", null);
