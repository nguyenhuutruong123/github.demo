...
<%
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("XuatNhapTonKhachHangTTSvl","", userId);
%>
<% String nnId = (String)session.getAttribute("nnId"); %> 
<% if(nnId == null) {
	nnId = "vi"; 
	}	
String url = util.getChuyenNguUrl("XuatNhapTonKhachHangTTSvl","",nnId);	
	%>
...
<form name="rpForm" method="post" action="../../XuatNhapTonKhachHangTTSvl">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
				...
				<TR>
					...
					<TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
						<TR>
							...
							<FIELDSET>
							  <LEGEND class="legendtitle"><%=ChuyenNgu.get("Báo cáo xuất nhập tồn của khách hàng",nnId) %></LEGEND>
							<TABLE  width="100%" cellpadding="6px" cellspacing="0px">
								<TR>
									...
									<TD class="plainlabel" width="130px"><%=ChuyenNgu.get("Đến ngày",nnId) %></TD>
									<td class="plainlabel">
