                                ...
                                <% 
                                    ...
                                    while ( chitieuSKU.next()){
                                        ...
                                        <%}%>
                                                ...
                                                <TD align="center"> 
                                                <%if( chitieuSKU.getString("trangthai").trim().equals("0") ) {%>
					                                <A href = "../../ChiTieuSKUInTTUpdateSvl?userId=<%=userId%>&update=<%= chitieuSKU.getString("pk_seq") %>"><IMG src="../images/Edit20.png" alt="Cap nhat" title="Cập nhật" border=0></A>&nbsp;
					                                <A href = "../../ChiTieuSKUInSvl?userId=<%=userId%>&delete=<%= chitieuSKU.getString("pk_seq") %>&&view=TT"><img src="../images/Delete20.png" alt="Xoa" title="Xóa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa chỉ tiêu này?')) return false;"></A>									
							                   <%} else { %>
							                   		<A href = "../../ChiTieuSKUInTTUpdateSvl?userId=<%=userId%>&display=<%= chitieuSKU.getString("pk_seq") %>"><IMG src="../images/Display20.png" alt="Hien thi" title="Hiển thị" border=0></A>&nbsp;
							                   <%} %>
							                    </TD>
                                            </TR>
                                        <% m++; } %>  
