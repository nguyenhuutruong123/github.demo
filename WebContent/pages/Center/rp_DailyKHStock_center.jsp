...
<%
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("DailyKHStockTTSvl","", userId);
%>
<% String nnId = (String)session.getAttribute("nnId"); %> 
<% if(nnId == null) {
	nnId = "vi"; 
	}	
String url = util.getChuyenNguUrl("DailyKHStockTTSvl","",nnId);	
	%>
...
<form name="rpForm" method="post" action="../../DailyKHStockTTSvl">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
				...
				<TR>
					...
					<TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
						<TR>
							...
							<FIELDSET>
							  <LEGEND class="legendtitle"><%=ChuyenNgu.get("Tồn Kho Cửa Hiệu",nnId) %></LEGEND>
