...
function TinhTien()
{
	...
	//Check xem co nhap scheme khong
	function Scheme()
	{
		var masp = document.getElementsByName("ckDetail.scheme");
		var tensp = document.getElementsByName("ckDetail.sotien");
										        ...
										        <TD   class="plainlabel"><input name="SoTienCoVAT" id="SoTienCoVAT" type="text" readonly="readonly" 
										          ...
										          VND </TD>
											       ...
											       <%if(hdBean.getloaichietkhau().equals("1")){ %>
											       		<a href="" id="ckDetail" rel="subcontent"><img alt="Số lô - Số lượng nhận" src="../images/vitriluu.png"></a>
				                    ...
				                    <table width="90%" align="center">
					                        	...
					                        	<%
					                        		...
					                        		if(hdBean.getScheme() != null)
					                        		{
							                            ...
							                            <td>
							                            	<input type="text" size="100px" name="ckDetail.sotien" value="<%= hdBean.getSotien()[j] %>" onchange="Tinh()"  onkeypress="return keypress(event);" />
							                            </td>
							                        	</tr>
						                        			<% 
						                        			count++;
				                     	...
				                     	<a href="javascript:dropdowncontent.hidediv('subcontent')">Hoàn tất</a>
											  ...
											  <TD  ><input name="ghichu" id="ghichu" style="width: 100%"  type="text" 
                                          	 ...
                                          	 <TD  class="plainlabel">Nội dung chiết khấu </TD>
											  <TD  class="plainlabel"><input name="noidungchietkhau" style="width: 100%" id="noidungchietkhau" type="text" value="<%=hdBean.getNoidungchietkhau() %>" >
											  </TD>
											  </TR>
