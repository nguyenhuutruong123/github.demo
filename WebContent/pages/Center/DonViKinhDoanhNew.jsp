...
<form name="dvkdForm" method="post" action="../../DvkdNewSvl">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
				  	...
				  	<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
									<TR>
									  <TD width="15%" class="plainlabel required" ><%=ChuyenNgu.get("Đơn vị kinh doanh",nnId) %> <FONT class="erroralert"></FONT></TD>
									  <TD  class="plainlabel" ><INPUT name="dvkd" style="width:300px" type="text" value ='<%=dvkdBean.getDvkd()%>' ></TD>
								  </TR>
									<TR>
									  <TD  class="plainlabel" ><%=ChuyenNgu.get("Diễn giải",nnId) %> </TD>
									  <TD  class="plainlabel" ><INPUT name="diengiai" style="width:300px" type="text" value ='<%=dvkdBean.getDiengiai()%>' ></TD>
								  </TR>

									<TR>
									  <TD colspan="2" class="plainlabel" >
									  	<label>
									  	<% if (dvkdBean.equals("1")) { %>
