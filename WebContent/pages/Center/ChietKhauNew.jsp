    ...
    <fieldset>
    	<legend class="legendtitle">Thông tin chiết khấu </legend>
            ...
            <TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
				<TR>
				  <TD width="15%" class="plainlabel" ><%=ChuyenNgu.get("Diễn giải",nnId) %></TD>
				  <TD  class="plainlabel" ><INPUT name="diengiai" 
					type="text" value='<%= ckBean.getDiengiai() %>' size="20"></TD>
			  	</TR>
				<TR>
				  <TD width="15%" class="plainlabel" ><%=ChuyenNgu.get("Số tiền",nnId) %> <FONT class="erroralert"></FONT></TD>
				  <% 
					  String gia="";
				  ...
				  <TD  class="plainlabel" ><INPUT name="sotien" id="sotien" onkeyup="Dinhdang(this)"
					type="text" value='<%= gia %>' size="20"> <%=ChuyenNgu.get("VNĐ",nnId) %></TD>
			  	</TR>
				<TR>
				  <TD class="plainlabel" ><%=ChuyenNgu.get("Mức chiết khấu",nnId) %> <FONT class="erroralert"></FONT></TD>
				  <TD class="plainlabel" >
           ...
           <TABLE class="tabledetail" width="100%" border="0" cellpadding="1" cellspacing="1" >
                <TR class="tbheader">                   
                 	<TH align="center" width="25%"> <%=ChuyenNgu.get("Mã NPP",nnId) %> </TH>
                	<TH align="left" width="65%"> <%=ChuyenNgu.get("Tên NPP",nnId) %> </TH>
