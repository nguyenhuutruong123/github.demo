...
function replaces()
{
	...
	for(i=0; i < masp.length; i++)
	{
		if(masp.item(i).value != "")
		{
			...
			if(pos > 0)
			{
				...
				quydoi1.item(i).value = sp.substring(0, parseInt(sp.indexOf("] [")));
				sp = sp.substr(parseInt(sp.indexOf("] [")) + 3);
	...
	{    
	 ...
	 {	
		 ...
		 {	
			alert("Error, không có sản phẩm nào được bạn chọn !");
			return;
		 }
								...
								<TR>
									<TD align="left">						
										...
										<TABLE cellpadding = "3" cellspacing = "0" width = "100%" border = 0>
											...
											<TR class="tblightrow">
	               							<TD width="170px" class="plainlabel">Ngày giao hàng </TD>
												  <TD class="plainlabel">
												 	  <input type="text"  class="days" size="11"
							   		...
							   		<TD>
										...
										<tbody id="san_pham">
												<TR class="tbheader" >
													...
													<TH width="7%">DVT</TH>
													<TH width="7%">Quy Đổi (KG)</TH>
													<TH width="7%"style="display: none">Đơn giá gốc</TH>
													...
													<TH width="10%"style="display: none">Đơn giá sau CK </TH>
													
													<TH width="7%" style="display: none">Chiết khấu </TH>
													<TH width="9%"style="display: none">Thành tiền </TH>
													<TH width="9%"  style="display: none">CTKM</TH>
												</TR>
									<% 
							if(splist != null){
							...
							while (m < size){
								...
								%>
						        	...
						        	<% if (spThieuList.containsKey(sanpham.getMasanpham())){ %>
									    ...
									    <TD align = "center" style="display: none"><div class="addspeech" title="San pham nay con toi da <%= spThieuList.get(sanpham.getMasanpham()) %> san pham, vui long chon lai so luong">
								...
								<TR class= 'tblightrow'>
								    ...
								    <TD align = "center"  style="display: none">
								    	<input type="text" name="dongia1"   onkeyup="Dinhdang(this)"   style="width:100% ;text-align:right; color: black;">
								    	<input type="hidden" name="dongia" readonly style="width:100% ;text-align:right">
								    </TD>
								    
								    <TD align="center" style="display: none" style="display: none" >
