                      ...
                      <TABLE class="" width="100%">
                        <TR>
                            ...
                            <TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
                                <TR class="tbheader">
                                    <TH width=""><%=ChuyenNgu.get("Từ ngày",nnId) %> </TH>
                                    <TH width=""><%=ChuyenNgu.get("Đến ngày",nnId) %>  </TH>
                                    ...
                                    while (luongkhacRs.next()){
                                        ...
                                        <%}%>
                                                ...
                                                <% if(luongkhacRs.getString("TRANGTHAI").trim().equals("0")){%>
                                                 ...
                                                 <TD align="center"><%=ChuyenNgu.get("Đã xóa",nnId) %></TD>
                                                 <%}else{ %>
                                                ...
                                                <TD align="center">
                                                    ...
                                                    <TD>
                                                   		...
                                                   		<A href = "../../RouterSvl?task=<%=util.dongMa(getServletContext().getInitParameter("RedirectNoScript") + "ThuongdauthungSvl?userId="+userId+"&delete="+luongkhacRs.getString("PK_SEQ")) %> ">
                                                        	<img src="../images/Delete20.png" alt="Xoa" width="20" height="20" title="Xóa" border=0 onclick="if(!confirm('Bạn chắc chắn muốn xóa thưởng  này?')) return false;">
                                                    	</A>
                                                     	<%} %>
                                                    </TD>
                                                     <TD>
                                                     	...
                                                     	<A href = "../../RouterSvl?task=<%=util.dongMa(getServletContext().getInitParameter("RedirectNoScript") + "ThuongdauthungSvl?userId="+userId+"&chot="+luongkhacRs.getString("PK_SEQ")) %> ">
                                                        	<img src="../images/Chot.png" alt="Chốt" width="20" height="20" title="Chốt chỉ tiêu" border = 0 onclick="if(!confirm('Bạn chắc chắn muốn chốt thưởng này?')) return false;">
                                                       	</A>
                                                     	<%} %>
                                                     </TD>
                                                     <%}else   if(luongkhacRs.getString("TRANGTHAI").trim().equals("2")){ %>
                                                  ...
                                                  <%}else{ %>
                                                     ...
                                                     <TD>
                                                     	...
                                                     	<A href = "../../RouterSvl?task=<%=util.dongMa(getServletContext().getInitParameter("RedirectNoScript") + "ThuongdauthungSvl?userId="+userId+"&unchot="+luongkhacRs.getString("PK_SEQ")) %> ">
                                                        	<img src="../images/unChot.png" alt="Hien thi" width="20" height="20" title="Hiển thị" border = 0 onclick="if(!confirm('Bạn chắc chắn muốn  mở chốt thưởng này?')) return false;">
                                                       	</A>
                                                    	<%} %>
                                                     </TD>
                                                    <%}%>
