...
<!-- END RENDER AUTO -->
	...
	<form name="frm" method="post" action="../../BCLuongThuong">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Quản lý nhân sự > Báo cáo > Lương nhân viên </div>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Lương nhân viên</legend>
					<div style="width: 100%; float: none" align="left">
						<div style="width: 100%; float: none" align="left" class="plainlabel">
							<TABLE width="70%" cellpadding="6" cellspacing="0">
								...
								<TR>
									<TD class="plainlabel">Định dạng</TD>
									<TD class="plainlabel" colspan="3">
										<select name="dinhdang" id="dinhdang">
											<option value="0" selected>Định dạng chuẩn</option>
											<option value="1" >Định dạng in</option>
											<option value="2" >Định dạng tờ trình</option>
										</select>
									</TD>									
								</TR>
