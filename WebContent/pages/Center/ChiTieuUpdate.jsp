								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản
											lý chỉ tiêu &gt; Chỉ tiêu cho NPP &gt; Chỉ tiêu cho bán ra
											&gt; Cập nhật</TD>
										...
										<div>
											<TABLE width="1600px" border="1" cellspacing="1px"
												...
												<TR class="tbheader">
													...
													<TH width="19%">Tên nhà phân phối</TH>
													<TH width="7%">Số đơn hàng</TH>
													<TH width="7%">Sản lượng / đơn hàng</TH>
													<TH width="7%">SellsOut</TH>
													<TH width="7%">% Khách Hàng Mua Hàng</TH>
													<TH width="7%">Số Khách Hàng Mới</TH>
													<TH width="7%">Tỷ Lệ Giao Hàng</TH>
													<TH width="7%">Độ Chính Xác Tồn Kho</TH>
													<%
														int col = 5;
														if (nhomsp != null) {
