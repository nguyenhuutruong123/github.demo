...
<%	String userId = (String) session.getAttribute("userId");  
	...
	<%
		...
		int[] quyen = new  int[6];
		quyen = util.Getquyen("Salesreperformance","", userId);
	%>
...
<!-- END RENDER AUTO -->
	...
	<form name="frm" method="post" action="../../Salesreperformance">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
	<input type="hidden" name="action" value='1'>
	<input type="hidden" name="userId" value='<%=userId%>'>
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation"> Quản lý chỉ tiêu &#62; Báo cáo &#62; Thực hiện chỉ tiêu SR</div>
...
<%
	try
	{
		...
		if(kenh != null){ kenh.close(); ddkd=null; }
