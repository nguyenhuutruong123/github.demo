							...
							<TABLE width="100%" cellpadding="6" cellspacing="0">
								...
								<TR>
									...
									String[]	tt = new String[]
														{"All" ,"Chưa duyệt", "Đã duyệt", "Đã hủy","PDA" };
					...
					<TABLE class="" width="100%">
						<TR>
							...
							<TABLE width="100%" border="0" cellspacing="1px" cellpadding="4px">
								...
								<!-- 	<TH align="center" style="width: 5%" class="nosort" >Duyệt </BR> tất cả<br /> 
	                    				<input type="checkbox" id="duyetchkALL" onchange="checkALLDuyet();" >  
	                    				<A href = "javascript:DuyetALL();"><IMG src="../images/duyet.png" width = "30px" height = "30px" title="Duyệt tất cả đơn hàng" border=0></A>
	               				   </TH> -->
									 <TH align="center" style="width: 5%" class="nosort" >Duyệt </BR> tất cả<br /> 
	                    				<input type="checkbox" id="chkALL" onchange="checkALL();" >  
	                    				<A href = "javascript:ChotALL();"><IMG src="../images/Chot.png" title="Chốt tất cả đơn hàng" border=0></A>
	               				   </TH>
									...
									while (dhlist.next()){
										...
										<%}%>
												...
												<TABLE border = 0 cellpadding="0" cellspacing="0" >
													<TR><TD>
													<%if(trangthai.equals("0")){ %>
														<A href = "../../DonhangIPUpdateSvl?userId=<%=userId%>&update=<%= dhlist.getString("dhId") %>"><img src="../images/Edit20.png" alt="Cap nhat" title="Cập nhật" width="20" height="20" longdesc="Cap nhat" border = 0></A> &nbsp;
														
														
														<A id='<%="xoadhid" + dhlist.getString("dhId") %>'
														   href=""><img 
														   src="../images/Delete20.png" alt="Xóa đơn hàng" width="20" height="20" longdesc="Xóa đơn hàng"
														   border=0	onclick="if(!confirm('Bạn có muốn xóa đơn hàng này?')) {return false ;}else{ processing('<%="xoadhid" + dhlist.getString("dhId") %>' , '../../DonhangIPSvl?userId=<%=userId%>&delete=<%= dhlist.getString("dhId") %>');}" >
														</A>
														<A href = "../../DonhangIPUpdateSvl?userId=<%=userId%>&display=<%= dhlist.getString("dhId") %>"><img src="../images/Display20.png" alt="Hien thi" title="Hiển thị" width="20" height="20" longdesc="Hien thi" border = 0></A>
													...
													<A href = "../../DonhangIPUpdateSvl?userId=<%=userId%>&update=<%= dhlist.getString("dhId") %>"><img src="../images/Edit20.png" alt="Cap nhat" title="Cập nhật" width="20" height="20" longdesc="Cap nhat" border = 0></A> &nbsp;
														<A id='<%="xoadhid" + dhlist.getString("dhId") %>'
														   href=""><img 
														   src="../images/Delete20.png" alt="Xóa đơn hàng" width="20" height="20" longdesc="Xóa đơn hàng"
														   border=0	onclick="if(!confirm('Bạn có muốn xóa đơn hàng này?')) {return false ;}else{ processing('<%="xoadhid" + dhlist.getString("dhId") %>' , '../../DonhangIPSvl?userId=<%=userId%>&delete=<%= dhlist.getString("dhId") %>&nppId=<%= obj.getNppId() %>');}" >
														</A>
														<A href = "../../DonhangIPUpdateSvl?userId=<%=userId%>&display=<%= dhlist.getString("dhId") %>"><img src="../images/Display20.png" alt="Hien thi" title="Hiển thị" width="20" height="20" longdesc="Hien thi" border = 0></A>
