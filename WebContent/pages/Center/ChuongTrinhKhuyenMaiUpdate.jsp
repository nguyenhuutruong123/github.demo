...
<head>
   ...
   <script>
    ...
    <script language="javascript" type="text/javascript">
    	...
    	function submitFormStop(){
			document.forms["ctkmForm"].action.value = "ngunghoatdong";
		...
		function saveform()
		{
			...
			if(document.getElementById("loaiCt").value != "4")
			{
						...
						//var apphanbo = document.getElementById("apphanbochecked");
						if(document.getElementById("apphanbochecked").checked == true)
			
					 	//if(apphanbo.checked == true)
					 		//console.log('apphanbo : '+ apphanbo);
					 	//if(apphanbo.checked)
					 	{
		...
		{ 	
		 ...
		 function Show()
		 {
		 	...
		 	/* var apphanbo = document.getElementById("apphanbochecked");
		 	if(apphanbo.checked) */
		 	if(document.getElementById("apphanbochecked").checked == true) { element.style.display = ""; }
               ...
               <TABLE width="100%" cellpadding="4" cellspacing="0">								
                   ...
                   <% } else {%>                
                    ...
                    <TD class="plainlabel" >Kênh bán hàng </TD>
                        ...
                        <%
                        	if(ctkmBean.checkNgayNgungHoatDong()){%>
                        		<TD class="plainlabel" colspan = "1" >
										<div id="btnSave1">
											<a class="button" style="width:120px" href="javascript:submitFormStop();"> <img
												style="top: -4px;" src="../images/button.png" alt="">Ngừng hoạt động</a>
										</div>
								</TD>
                        	<%}else {%>
                        		<TD class="plainlabel" colspan = "1" ></TD>
                        	<%}
                        %>
                        
						<TD class="plainlabel">Ngày ngừng hoạt động: <%=ctkmBean.getNgayngunghoatdong() %></TD>
                    </TR>
                    <TR>
                        <TD class="plainlabel" >Loại ngân sách </TD>
                        <TD class="plainlabel" colspan="3" >
                            <% if(ctkmBean.getLoaiNganSach().equals("1")){ %>
                            	<input onchange="submitform();" type="radio" name="loains" value = "1" checked = "checked" id="apphanbochecked" >Áp phân bổ &nbsp;&nbsp;
                            	<input onchange="submitform();" type="radio" name="loains" value = "0"  id="khonggh" >Không giới hạn ngân sách
                            <%}else{ %>
                            	<input onchange="submitform();" type="radio" name="loains" value = "1"  id="apphanbochecked" >Áp phân bổ &nbsp;&nbsp;
                            	<input onchange="submitform();" type="radio" name="loains" value= "0" checked="checked" id="khonggh" >Không giới hạn ngân sách
                            <%} %>
