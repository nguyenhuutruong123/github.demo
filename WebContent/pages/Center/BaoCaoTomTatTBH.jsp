...
<%
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("BaoCaoTomTatTBH","", userId);
...
String url = util.getChuyenNguUrl("BaoCaoTomTatTBH","",nnId);	
 %>
 ...
 <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle"><%=ChuyenNgu.get("Tóm tắt tuyến bán hàng",nnId) %> </legend>
