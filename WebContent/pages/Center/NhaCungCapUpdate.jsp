					...
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">
							   		&nbsp;Dữ liệu nền &gt; Cơ bản &gt; Nhà cung cấp &gt; Cập nhật</TD>
						   ...
						   <TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
								  ...
								  <TR>
									  ...
									  <TD class="plainlabel" ><INPUT id="sotaikhoan" name="sotaikhoan" maxlength="100" value ='<%=ncc.getSotaikhoan() %>' style="width:300px"   type="text"></TD>
								  </TR>
								  <TR>
									  <TD class="plainlabel required" >Điện thoại <FONT class="erroralert"></FONT></TD>
									  <TD class="plainlabel" ><INPUT id="dienthoai" name="dienthoai" maxlength="100" value ='<%=ncc.getDienthoai() %>' style="width:300px"   type="text"></TD>
								  </TR>
								  <TR>
									  <TD class="plainlabel required" >Fax <FONT class="erroralert"></FONT></TD>
									  <TD class="plainlabel" ><INPUT id="fax" name="fax" maxlength="100" value ='<%=ncc.getFax() %>' style="width:300px"   type="text"></TD>
								  </TR>
								   <TR>
