...
<%
	...
	String url="Quản lý chỉ tiêu > Chỉ tiêu nhân viên > Chỉ tiêu cho Bán Ra > Hiển thị";
	if(obj.getLoaichitieu().equals("1")){
		 url="Quản lý chỉ tiêu > Chỉ tiêu nhân viên > Chỉ tiêu cho Mua Vào > Hiển thị";
	}
%>
					...
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="1">
						...
						<TR>
							<TD height="100%" width="100%">
								...
								<TD width="150px" class="plainlabel" valign="top"> Năm </TD>
