	...
	gvChartInit();
		...
		jQuery(document).ready(function(){
			...
			jQuery(table).gvChart({
				chartType: 'AreaChart',
				gvSettings: {
					vAxis: {title: 'Doanh số  (Đơn vị tính: VNĐ) '},
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR height="22">
								<TD align="left" colspan="2" class="tbnavigation">&nbsp;Báo cáo quản trị > Báo cáo chart > Mức độ tăng trưởng sản phẩm </TD>
					...
					<TD width="100%">
						<FIELDSET>
							...
							<TABLE class="" width="100%" border="1" style="width:100%; float:none; clear:left; font-size:1.7em">
								...
								<caption align="left" >Doanh số (Đơn vị tính: VNĐ) </caption>
