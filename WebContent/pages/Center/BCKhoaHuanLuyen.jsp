		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Quản lý nhân sự > Báo cáo > Khóa huấn luyện </div>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Khóa huấn luyện nhân viên</legend>
					<div style="width: 100%; float: none" align="left">
						<div style="width: 100%; float: none" align="left"
							class="plainlabel">
							<TABLE width="70%" cellpadding="6" cellspacing="0">
								<TR>
                             	<TD class="plainlabel" >Khóa huấn luyện </TD>
								<TD class="plainlabel">
		                          ...
		                          <DIV id="subcontentKhl" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
						                    ...
						                    <table width="90%" align="center" cellpadding="2" cellspacing="1">
						                        <tr>
						                            <th width="75px" style="font-size: 12px">Mã khóa</th>
						                            <th width="250px" style="font-size: 12px">Tiêu đề</th>
						                            <th width="75px" style="font-size: 12px">Từ ngày</th>
						                            <th width="75px" style="font-size: 12px">Đến ngày</th>
						                            <th width="75px" align="center" style="font-size: 12px">Chọn hết <input type="checkbox" onchange="sellectAll()" id="chkAll" ></th>
						                        </tr>
				                            	<%
					                        		if(khoahvRs != null)
					                        		{
					                        			...
					                        			<tr>
					                        				<td><input style="width: 100%" value="<%= khoahvRs.getString("pk_seq") %>"></td>
					                        				<td><input style="width: 100%" value="<%= khoahvRs.getString("tieude") %>"></td>
					                        				<td><input style="width: 100%" value="<%= khoahvRs.getString("tungay") %>"></td>
					                        				<td><input style="width: 100%" value="<%= khoahvRs.getString("denngay") %>"></td>
					                        				<td align="center">
					                        				<% if(obj.getKhlId().indexOf(khoahvRs.getString("pk_seq")) >= 0 ){ %>
					                        					<input type="checkbox" name="khlIds" checked="checked" value="<%= khoahvRs.getString("pk_seq") %>">
					                        				<%}else{ %>
					                        					<input type="checkbox" name="khlIds" value="<%= khoahvRs.getString("pk_seq") %>">
					                        				<%} %>
					                        				</td>
					                        			</tr>
								...
								<TR>
									...
									<TD class="plainlabel" colspan="3">
										<select name="muclay" id="muclay">
											<option value="0" selected>Nhân viên bán hàng</option>
											<option value="1" >Giám sát bán hàng</option>
										</select>
									</TD>									
								</TR>
