...
<%@ page  import = "geso.dms.center.util.ChuyenNgu" %>	
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("BCDonHangHuyTrongKyTT","", userId);
	%>
	<% String nnId = (String)session.getAttribute("nnId"); %> 
<% if(nnId == null) {
 nnId = "vi"; 
 }
String url = util.getChuyenNguUrl("BCDonHangHuyTrongKyTT","",nnId);	
 %>
...
<!-- END RENDER AUTO -->
	...
	<form name="frm" method="post" action="../../BCDonHangHuyTrongKyTT">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
						...
						<div style="width: 100%; float: none" align="left"
							...
							<TABLE width="70%" cellpadding="6" cellspacing="0">
								...
								<tr>
									...
									<TD class="plainlabel">
									<select name="npp" id="npp" onchange="seach();">
						...
						<div style="width: 100%; float: none; display : none;">
							<div style="width: 30%; float: left">
								<fieldset style="min-height: 200px">
									<legend class="legendtitle"><%=ChuyenNgu.get("Field ẩn",nnId) %>  </legend>
							...
							<div style="width: 30%; float: left;">
								<fieldset style="min-height: 200px;">
									<legend class="legendtitle"><%=ChuyenNgu.get("Tất cả các Field",nnId) %>  </legend>
									<TABLE width="100%" border="0" cellspacing="1" cellpadding="4"
										id="tbAllFields">
										<tbody id="AllFields">
											<tr class="tbheader">
