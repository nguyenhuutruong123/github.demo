						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">
							 		&nbsp;Dữ liệu &gt; Sản phẩm  &gt; Catalog > Tạo mới</TD> 
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<TR>
						  	  	...
						  	  	<TD class="plainlabel" >
						  	  	<INPUT type="text" name="Ma" style="width:200px" value=''>
						  	  	</TD>
							...
							<TR>
								...
								<TD class="plainlabel"><INPUT type="text" name="ten" style="width:200px" value=''></TD>
