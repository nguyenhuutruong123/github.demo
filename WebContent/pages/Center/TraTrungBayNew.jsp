    	...
    	<legend class="legendtitle"> Trả trưng bày</legend>
                        ...
                        <TD class="plainlabel">
                            <select name="type" id="type" onChange="submitform()">
                                	<% if(tratbBean.getType().equals("1")){ %>		                            	                            	
		                                ...
		                                <option value="2"><%=ChuyenNgu.get("Trả sản phẩm",nnId) %></option>  
		                                <option value=""> </option>	
	                                <%} else {if(tratbBean.getType().equals("2")){ %>
	                                	<option value="2" selected><%=ChuyenNgu.get("Trả sản phẩm",nnId) %></option>  
               ...
               <TABLE class="tabledetail" id="content" width="100%" border="0" cellpadding="2" cellspacing="1">
                    <TR class="tbheader">
                        ...
                        <TH align="left" width="60%"><%=ChuyenNgu.get("Tên sản phẩm",nnId) %></TH>
                        <TH align="center"> <%=ChuyenNgu.get("Đơn giá",nnId) %></TH>
                        <% if(tratbBean.getHinhthuc().equals("1")){ %>
