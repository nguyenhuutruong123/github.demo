...
<%
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("SAP_SO_REJECT","", userId);
...
<!-- END RENDER AUTO -->
	...
	<form name="ckParkForm" method="post" action="../../SAP_SO_REJECT">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Báo cáo quản trị > Đơn hàng hủy </div>
