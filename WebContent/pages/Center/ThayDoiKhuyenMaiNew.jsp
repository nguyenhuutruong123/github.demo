...
<div id="main" style="width:99%; padding-left:2px">
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle"><%=ChuyenNgu.get("Thêm sản phẩm chương trình khuyến mãi",nnId) %> </legend>
        		<div style="float:none; width:100%" align="left">
                <TABLE width="100%" cellpadding="6" cellspacing="0">								
                    <TR>
                        <TD class="plainlabel"  width="15%"><%=ChuyenNgu.get("Loại",nnId) %></TD>
                        <TD class="plainlabel">
                            <select name="loai" id="loai" style="width:250px;"   onChange="submitform()" class="select2" >
                            <option value="" > </option>
                                <% if(tdkmBean.getLoai().equals("1")){ %>
	                                <option value="1" selected><%=ChuyenNgu.get("Điều kiện khuyến mãi",nnId) %></option>
	                                <option value="2" ><%=ChuyenNgu.get("Trả khuyến mãi",nnId) %></option>
	                            <%}else{ if(tdkmBean.getLoai().equals("2")){ %>
	                            	<option value="1" ><%=ChuyenNgu.get("Điều kiện khuyến mãi",nnId) %></option>
	                                <option value="2"  selected ><%=ChuyenNgu.get("Trả khuyến mãi",nnId) %></option>
	                            <%}else{%>
	                            	<option value="1" ><%=ChuyenNgu.get("Điều kiện khuyến mãi",nnId) %></option>
	                                <option value="2"  ><%=ChuyenNgu.get("Trả khuyến mãi",nnId) %></option>                        
	                            <%}} %>
...
<%if(tdkmBean.getLoai().equals("1")){ %>
                    <TR>
						<TD class="plainlabel"><%=ChuyenNgu.get("Điều kiện khuyến mãi",nnId) %> </TD>
							<TD class="plainlabel">
...
<%}else if(tdkmBean.getLoai().equals("2")) { %>
					<TR>
						<TD class="plainlabel"><%=ChuyenNgu.get("Trả khuyến mãi",nnId) %> </TD>
							<TD class="plainlabel">
					 ...
					 <TR>
	                        <TD class="plainlabel"><%=ChuyenNgu.get("Hình thức",nnId) %> </TD>
	                        <TD class="plainlabel">
...
<%if( tdkmBean.getTrakmId().length()>0 ||tdkmBean.getDkkmId().length()>0 ){ %>                    
                    <TR>
						<TD class="plainlabel"><%=ChuyenNgu.get("Chương trình khuyến mại sử dụng",nnId) %> </TD>
							<TD class="plainlabel">
...
<%} %>
              <TR>
               ...
               <div align="left" style="width:100%; float:none; clear:none;">
                <fieldset>
    			<legend class="legendtitle"> <%=ChuyenNgu.get("Sản phẩm hiện tại",nnId) %> </legend>
        	...
        	<div align="left" style="width:100%; float:none; clear:none;">
        	 ...
        	 <fieldset>
    			<legend class="legendtitle"> <%=ChuyenNgu.get("Sản phẩm mới",nnId) %> </legend>
        		   <TABLE class="tabledetail" width="100%" border="0" cellpadding="1" cellspacing="1" >
		                <TR class="tbheader">                   
		                	<TH align="center" width="15%"><%=ChuyenNgu.get("Mã sản phẩm",nnId) %></TH>
		                	<TH align="left" width="73%"><%=ChuyenNgu.get("Tên sản phẩm",nnId) %></TH>
		               	 	<TH align="center" width="10%"><%=ChuyenNgu.get("Số lượng /Số tiền",nnId) %></TH>
		                </TR>
		                <% 
		                	String readonly="";
