...
<form name="khoForm" method="post" action="../../KhoNewSvl" charset="utf-8">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
				  	...
				  	<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
									<TR>
									  <TD width="15%" class="plainlabel required" ><%=ChuyenNgu.get("Tên kho",nnId) %> <FONT class="erroralert"></FONT></TD>
									...
									<TR>
									  ...
									  <% if(khoBean.equals("1")) { %>
									    <input name="trangthai" type="checkbox" value="1" checked ><%=ChuyenNgu.get("Hoạt động",nnId) %>
									    <% } else { %>
									    <input name="trangthai" type="checkbox" value="1" ><%=ChuyenNgu.get("Hoạt động",nnId) %>
									    <% } %>
								       </label></TD>
