...
<SCRIPT language="javascript" type="text/javascript">
 ...
 function saveform()
 {
	 if(document.getElementById("vungmien").value=="")
		 {
		 	alert("Bạn chưa nhập tên của vùng miền");
		 	return;
		 }
	 if(document.getElementById("ma").value=="")
	 {
	 	alert("Bạn chưa nhập Mã của vùng miền");
	 	return;
	 }
				  	...
				  	<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
									<TR>
									  <TD width="15%" class="plainlabel required" ><%=ChuyenNgu.get("Vùng miền",nnId) %> <FONT class="erroralert"></FONT></TD>
									  <TD  class="plainlabel " ><INPUT id="vungmien" name="vungmien"
								    ...
								    <TR>
									  <TD class="plainlabel required" ><%=ChuyenNgu.get("Mã",nnId) %> </TD>
									  <TD class="plainlabel" ><INPUT name="ma" id="ma"
										type="text" value='<%= vmBean.getMa() %>' style="width:400px"></TD>
								  </TR>
								  <TR>
								  <TD class="plainlabel"><%=ChuyenNgu.get("Quản lý vùng",nnId) %></TD>
