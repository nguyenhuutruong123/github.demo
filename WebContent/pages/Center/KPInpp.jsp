...
<%	String userId = (String) session.getAttribute("userId");  
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("KPInpp","", userId);
	%>
...
<form name="rpForm" method="post" action="../../KPInpp">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
					  ...
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   <TD align="left" colspan="2" class="tbnavigation">
						   	&nbsp;Báo cáo quản trị &gt; Theo dõi thành tích  &gt; Yếu tố nền tảng ĐDKD</TD>
