				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">Quản lý thông báo > Chức năng  >Nhóm nhân viên > Cập nhật</TD> 
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
						   ...
						   <TR>
						  	<TD class="plainlabel">Loại Nv</TD>
						  	  	<TD class="plainlabel">
								  <SELECT name="loainvId" id="loainvId"  style="width:200px" onchange = "submitform();"  >
						  	  		<OPTION value="" ></OPTION>	
						  	  		<% if(loaiNVRs!= null) {						  	  			
						   					while (loaiNVRs.next()) {
