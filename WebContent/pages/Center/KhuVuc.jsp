...
<TABLE width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">	
					...
					<TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
						<TR>
							...
							<TABLE  width="100%" cellpadding="6" cellspacing="0">
								<TR>
								    <TD width="20%" class="plainlabel"><%=ChuyenNgu.get("Vùng miền",nnId) %></TD>
						...
						<TR>
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
								<TR class="tbheader">
									...
									<TH width="13%"><%=ChuyenNgu.get("Vùng miền",nnId) %> </TH>
										...
										<%}%>
											<TD align="left"><div align="left"><%= kv.getMa() %></div></TD>
												...
												<TABLE border = 0 cellpadding="0" cellspacing="0">
													...
													<TD>
													<%if(quyen[3]!=0){ %>
                                                        <A href = "../../RouterSvl?task=<%= util.dongMa(getServletContext().getInitParameter("RedirectNoScript") +"KhuvucUpdateSvl?userId="+userId+"&display="+ kv.getId()+"")%>"><img src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" width="20" height="20" longdesc="Hiển thị" border = 0 "></A>
                                                    <%} %>
                                                    </TD>
                                                    <TD>&nbsp;</TD>
													<TD>
 ...
 "KhuvucUpdateSvl?userId="+userId+"&update="+kv.getId()+"")%>"><img src="../images/Edit20.png" alt="Cap nhat" title="Cập nhật" width="20" height="20" longdesc="Cap nhat" border = 0></A>
													<%} %>
													</TD>
													<TD>&nbsp;</TD>
													<TD>
													<%if(quyen[1]!=0){ %>
														<A href = "../../RouterSvl?task=<%= util.dongMa(getServletContext().getInitParameter("RedirectNoScript") +
 "KhuvucSvl?userId="+userId+"&delete="+kv.getId()+"")%>"><img src="../images/Delete20.png" alt="Xoa" title="Xóa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa khu vực này ?')) return false;"></A>
