...
<!-- END RENDER AUTO -->
	...
	<form name="ddkdForm" method="post"
		action="../../DaidienkinhdoanhUpdateSvl"> 
					...
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<TR>
							<TD height="100%" width="100%">
								<FIELDSET>
									<LEGEND class="legendtitle" style="color: black"><%=ChuyenNgu.get("Báo lỗi",nnId)%></LEGEND>
									<TABLE border="0" width="100%" cellpadding="4" cellspacing="0">
										...
										<TR>
											...
											<TD class="plainlabel" colspan="5"><input name="TrangThai"
										...
										<TR>
											...
											<TD class="plainlabel"><%=ChuyenNgu.get("Ngày kết thúc",nnId)%> <FONT
												class="erroralert">*</FONT></TD>
									...
									<TR>
										<TD colspan="4">
											<FIELDSET>
												...
												<%=ChuyenNgu.get("Chọn giám sát bán hàng",nnId)%></LEGEND>
