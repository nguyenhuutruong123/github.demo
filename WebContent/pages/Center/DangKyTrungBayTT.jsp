                                ...
                                <TR>
                                    <TD>
                                        ...
                                        <TR class="tbheader">
                                            ...
                                            <TH ><%=ChuyenNgu.get("Ngày bắt đầu",nnId) %></TH>
									...
									<%}%>
								     ...
								     <%if(dktbRs.getString("trangthai").equals("0")){ %>
								     		...
								     		<A href = "../../DangkytrungbayTTUpdateSvl?userId=<%=userId%>&update=<%=dktbRs.getString("pk_seq")%>"><img src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border = 0></A>
									   		...
									   		<A href = "../../DangkytrungbayTTUpdateSvl?userId=<%=userId%>&chot=<%=dktbRs.getString("pk_seq")%>"><img src="../images/Chot.png" alt="Chot" width="20" height="20" longdesc="Chot" border = 0 onclick="if(!confirm('Bạn có muốn duyệt đăng ký trưng bày này?')) return false;"></A>
									     	<%} %>
									     	
									     	<%if(quyen[Utility.XOA]!=0){ %>
									     	<A href = "../../DangkytrungbayTTUpdateSvl?userId=<%=userId%>&delete=<%=dktbRs.getString("pk_seq")%>"><img src="../images/Delete.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border = 0 onclick="if(!confirm('Bạn có muốn xóa đăng ký này?')) return false;"></A> 
									   		<%} %>
