				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý nhân sự > Khai báo > Qui trình làm việc > Tạo mới</TD> 
				  ...
				  <TD height="100%" width="100%">
					...
					<% 
                        ...
                        for(int i = 0; i < tcDetailList.size(); i++)
                        {
                        	...
                        	<tr>
                        		<td>
                        			<input type="text" style="width: 100%" name = 'matieuchi' value="<%= detail.getMa() %>" >
                    ...
                    <% 
	                    ...
	                    { 
	                    	...
	                    	<tr>
                        		<td>
                        			<input type="text" style="width: 100%" name = 'matieuchi' value="" >
                        			<input type="hidden" style="width: 100%" name = 'idtieuchi' value="" >
                        		</td>
                        		<td><input type="text" style="width: 100%" name = 'diengiaitc' value="" ></td>
                        		<td>
                        			<input type="text" style="width: 100%; text-align: right;" name = 'trongso' value="" onkeypress="return keypress(event);" >
                        			<input type="hidden" style="width: 100%; text-align: right;" name = 'chamlan1' value="" >
                        		    <input type="hidden" style="width: 100%; text-align: right;" name = 'chamlan2' value="" >
                        		    <input type="hidden" style="width: 100%; text-align: right;" name = 'chamlan3' value="" >
                        		</td>	
...
<script type="text/javascript">
	dropdowncontent.init('gsbhId', "right-bottom", 300, "click");
</script>
