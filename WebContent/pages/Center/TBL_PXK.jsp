		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Báo cáo quản trị > Phiếu xuất kho</div>
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				...
				<div id="btnSave">
					<A href="javascript:saveform()"><img src="../images/Save30.png"
						alt="Luu lai" title="Đồng bộ Dữ liệu" border="1"
							...
							<TABLE width="100%" cellpadding="6px" cellspacing="0px"
								...
								<TR>
									...
									<TD class="plainlabel" width="250px"><input type="text"
										...
										onChange="search();" /></TD>
									<TD class="plainlabel" width="120px">Số SO</TD>
									<TD class="plainlabel" width="250px"><input type="text"
										name="soso" value='<%=obj.getSoId()%>' onChange="search();" /></TD>
								</TR>
								<TR>
									<TD class="plainlabel" width="120px">Mã NPP</TD>
									<TD class="plainlabel" width="250px"><input type="text"
										name="CustomerId" value='<%=obj.getCustomerId()%>'
										onChange="search();" /></TD>
									<TD class="plainlabel" width="100px">Tên NPP</TD>
									<TD class="plainlabel" colspan="3"><input type="text"
			...
			<table width="100%">
				<tr>
					<td>
						...
						: ""%>><a
								href="#tabNhap">Phiếu xuất kho</a></li>
												...
												<TR class=<%=darkrow%>>
													...
													<TD align="center">
														...
														href="../../TBL_PXK_Display?userId=<%=userId%>&display=<%=hdRs.getString("SOCHUNGTU")+"-"+hdRs.getString("SOSO")%>"><img
															src="../images/Display20.png" alt="Hiển thị" title="Chốt"
