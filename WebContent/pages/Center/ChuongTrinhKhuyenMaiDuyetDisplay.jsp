                        ...
                        <TD class="plainlabel">
                        	...
                        	<% } else { %>
                        	 ...
                        	 <% if (ctkmBean.getPhanbotheoDH().equals("1")){ %> 
                        		<input type="checkbox" name="PHANBOTHEODH" value="1" checked="checked"><i> Phân bổ ngân sách theo số lượng </i>
                        	<% } else { %>
                        		<input type="checkbox" name="PHANBOTHEODH" value="1" ><i> Phân bổ ngân sách theo số lượng</i>
                        	 <% }  %>
                        </TD>
                        <TD class="plainlabel" colspan="3" >
                    </TR>
