...
<!-- END RENDER AUTO -->
	...
	<form name="frm" method="post" action="../../BCChiPhi">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Quản lý nhân sự > Báo cáo > Chi phí trên sản lượng </div>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Chi Phí Trên Sản Lượng</legend>
								 ...
								 <TR style="display: none">
									...
									<TD class="plainlabel">
										<select name="khuvucId" id="khuvucId" onchange="seach();">
											...
											<%if (khuvucs != null)
													while (khuvucs.next()) {
														if (khuvucs.getString("pk_seq").equals(obj.getKhuvucRs())) {%>
