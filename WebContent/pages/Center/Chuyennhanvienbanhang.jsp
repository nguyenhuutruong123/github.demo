...
<SCRIPT language="javascript" type="text/javascript">
	...
	{	   
		if(document.forms['kstdForm'].nhappcu.value==""){
			alert("Vui lòng chọn nhà phân phối cũ");
			return;
		}
			
		if(document.forms['kstdForm'].nhappmoi.value==""){
			alert("Vui lòng chọn nhà phân phối mới");
			return;
		}
    ...
    <div align="left" style="width:100%; float:none; clear:left">
  		...
  		<div id="content" >
	  	     <div id="nppcu"  align="left"  >		
	  	  		<%=ChuyenNgu.get("Chọn nhà phân phối cũ :",nnId) %> 
	  	  		...
	  	  		<div> 
	  	  			...
	  	  			<th><%=ChuyenNgu.get("Mã",nnId) %></th>
	  	  			<th><%=ChuyenNgu.get("Tên",nnId) %></th>
	  	  			<th><%=ChuyenNgu.get("Chọn",nnId) %></th>
	  	  			</tr>
	  	  			<%if(rsddkd!=null) { 
	  	  			while(rsddkd.next()){
	  	  				%>
	  		   ...
	  		   <div id="nppmoi"   align="left"  >		
	  	   		<%=ChuyenNgu.get("Chọn nhà phân phối mới :",nnId) %> 
	  	  		...
	  	  		<br>
	  	  <%-- 		Chỉ Copy  sang nhà phân phối mới :
	  	  		...
	  	  		<br>
	  	  		 <a  class="button"	href="javascript:saveform();"> <img style="top: -4px; "
											src="../images/button.png" alt=""><%=ChuyenNgu.get("Thực hiện",nnId) %>  </a> 	
