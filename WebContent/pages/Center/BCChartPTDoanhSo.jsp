...
<script src="../scripts/Chart/jquery.min.js" type="text/javascript"></script>
...
<!-- END RENDER AUTO -->
	...
	<form name="frm" method="post" action="../../BCChartPTDoanhSo">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Báo cáo quản trị > Báo cáo đồ thị > Phần trăm doanh số </div>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Phần trăm doanh số</legend>
					<div style="width: 100%; float: none" align="left">
						...
						<div class="main">
								<table id='myTable'>
								<% if(obj.getMuclay().equals("0")) { %>
									<caption align="left" >Phần trăm doanh số theo khu vực</caption>
								<% } else { %> 
									<caption align="left" >Phần trăm doanh số theo vùng</caption>
								<%} %>
									<thead>
										<tr>
											<th></th>
