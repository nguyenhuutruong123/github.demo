...
String url = util.getChuyenNguUrl("BCTinhhinhDms","",nnId);	
 %>
...
// 			}
		...
		document.forms['frm'].action.value = 'Taomoibc';
		document.forms["frm"].submit();
	/* 	reset(); */
	}
	...
	function quanly() 
	{
		...
		document.forms['frm'].action.value = 'chamcongql';
		document.forms["frm"].submit();
...
<!-- END RENDER AUTO -->
	...
	<form name="frm" method="post" action="../../BCTinhhinhDms">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			...
			<div align="left"
				style="width: 100%; float: none; clear: left; font-size: 0.7em">
					...
					<legend class="legendtitle"><%=ChuyenNgu.get("Báo cáo tình hình DMS",nnId) %> </legend>
							...
							<%if(!obj.getLoaiMenu().equals("NPP"))  {%>
                              ...
                              <%}} %>                             </select>		   										</TD>
								...
								<TR>
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
									<a class="button3"
										href="javascript:submitformbc();"> <img style="top: -5px;"
											src="../images/button.png" alt=""><%=ChuyenNgu.get("Chấm Công",nnId) %></a>
									<a class="button3"
										href="javascript:quanly();"> <img style="top: -5px;"
											src="../images/button.png" alt=""><%=ChuyenNgu.get("Chấm Công QL ",nnId) %></a>		
