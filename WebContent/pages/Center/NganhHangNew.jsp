				  	...
				  	<tr>
					   <TD align="left" colspan="4" class="legendtitle">
							...
							<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
								<TR>
								  <TD width="15%" class="plainlabel required" ><%=ChuyenNgu.get("Ngành hàng",nnId) %> <FONT class="erroralert"></FONT></TD>
...
<!-- 										          </select> -->
								...
								<TR>
								  ...
								  <TD class="plainlabel" >
							 	  ...
							 	  <TD class="plainlabel required"><%=ChuyenNgu.get("Đơn vị kinh doanh",nnId) %></TD>
				                  <TD class="plainlabel">
