...
<% 
   ...
   ResultSet gsbh = obj.getgsbh();
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("Dailypurchase_TTSvl","", userId);
...
String url = util.getChuyenNguUrl("Dailypurchase_TTSvl","",nnId);	
	%>
...
<!-- END RENDER AUTO -->
	...
	<form name="frm" method="post" action="../../Dailypurchase_TTSvl">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
	...
	<input type="hidden" name="userId" value='<%=userId%>'>
		<div id="main" style="width: 99%; padding-left: 2px">
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle"><%=ChuyenNgu.get("Hàng nhập kho",nnId) %></legend>
