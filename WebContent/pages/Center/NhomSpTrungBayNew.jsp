                ...
                <TR>
                    ...
                    <TD class="plainlabel">
                        ...
                        <% if(nsptbBean.getType().equals("1")){ %>                           
                            <option value="1" selected><%=ChuyenNgu.get("Số lượng từng sản phẩm bắt buộc",nnId) %></option>
                        ...
                        <%}else{if(nsptbBean.getType().equals("2")){ %>                      	
                            ...
                            <option value="1"><%=ChuyenNgu.get("Số lượng từng sản phẩm bắt buộc",nnId) %></option>
                            <option value=""> </option>
                        <%}else{ %>
