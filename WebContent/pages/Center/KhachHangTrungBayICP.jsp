...
<% ResultSet khList = bdBean.getKhChuaViengThamRs(); 
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("KhachHangTBSvl","&view="+bdBean.getView()+"", userId);
%>
...
<form name="bdForm" method="post" action="../../KhachHangTBSvl">  <% geso.dms.center.util.Csrf csdr=new geso.dms.center.util.Csrf(request,response,true,false,true);%> <input type="hidden" name="<%=csdr.get_tokenName() %>" value='<%=csdr.get_tokenValue() %>'>
...
<% 
	...
	if(cttbRs != null){ cttbRs.close(); cttbRs = null ;} 
