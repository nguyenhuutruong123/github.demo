	...
	if(e)
	{
		...
		(e.checked=t)?document.body.setAttribute("data-theme","dark"):document.body.removeAttribute("data-theme"),
		 ...
		 function(t)
		 {
			 ...
			 e.checked?(
					 /*table.setAttribute("class", "table table-dark table-striped table-sm table-bordered table-hover"),*/
					 table.classList.add("table-dark"),
			 localStorage.setItem("darkSwitch","dark")):
			(table.classList.remove("table-dark"), localStorage.removeItem("darkSwitch"));
